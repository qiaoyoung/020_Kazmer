...
@implementation StandInPerson

//: - (instancetype)initWithCNContact:(CNContact *)contact {
- (instancetype)initWithLight:(CNContact *)contact {
    //: self = [super init];
    self = [super init];
    //: if (self)
    if (self)
    {
        ...
        if ([contact isKeyAvailable:CNContactPhoneNumbersKey])
        {
            ...
            for (CNLabeledValue *labeledValue in contact.phoneNumbers)
            {
                ...
                if ([SizeTo with:labeledValue]) {
                    //: NIMContactPhone *phoneModel = [[NIMContactPhone alloc] initWithLabeledValue:labeledValue];
                    SizeTo *phoneModel = [[SizeTo alloc] initWithUnderTapValue:labeledValue];
...
@implementation SizeTo

//: - (instancetype)initWithLabeledValue:(CNLabeledValue *)labeledValue {
- (instancetype)initWithUnderTapValue:(CNLabeledValue *)labeledValue {
    //: self = [super init];
    self = [super init];
    //: if (self)
    if (self)
    {
        ...
        self.phone = [NSString occurrent:phoneNumber];
...
+ (BOOL)with:(CNLabeledValue *)labeledValue {
    //: CNPhoneNumber *phoneValue = labeledValue.value;
    CNPhoneNumber *phoneValue = labeledValue.value;
    //: NSString *phoneNumber = phoneValue.stringValue;
    NSString *phoneNumber = phoneValue.stringValue;
    //: NSString *userful = [NSString lj_filterSpecialString:phoneNumber];
    NSString *userful = [NSString occurrent:phoneNumber];
