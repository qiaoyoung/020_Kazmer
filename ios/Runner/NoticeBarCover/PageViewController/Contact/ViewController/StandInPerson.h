...
@interface StandInPerson : NSObject
...
@property (nonatomic, copy) NSArray <SizeTo *> *phones;
...
@interface MakeAccount : NSObject

//: @property (nonatomic, copy) NSString *key;
@property (nonatomic, copy) NSString *key;

//: @property (nonatomic, copy) NSArray <CCCContactPerson *> *persons;
@property (nonatomic, copy) NSArray <StandInPerson *> *persons;
