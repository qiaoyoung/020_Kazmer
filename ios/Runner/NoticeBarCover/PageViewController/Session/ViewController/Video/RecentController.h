...
@protocol SubOldDelegate <NSObject>
...
@interface RecentController : NSObject

//: @property (nonatomic, weak) id <LYVideoPlayerDelegate> delegate;
@property (nonatomic, weak) id <SubOldDelegate> delegate;
