...
@implementation PtolemaicSystemView
...
- (UIButton *)sureBtn {
    ...
    if (!_sureBtn) {
        ...
        [_sureBtn setTitle:@"发送".textIndex forState:UIControlStateNormal];
    }
    //: return _sureBtn;
    return _sureBtn;
}
...
- (UIButton *)deleteButton
{
    ...
    if (!_deleteButton) {
        ...
        [_deleteButton setTitle:@"删除".textIndex forState:UIControlStateNormal];
    }
