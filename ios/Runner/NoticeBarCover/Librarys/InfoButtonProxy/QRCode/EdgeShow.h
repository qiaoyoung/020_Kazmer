...
#import "QuickDelegate.h"

//: @interface SGScanCode : NSObject
@interface EdgeShow : NSObject
/// 类方法创建
...
@property (nonatomic, weak) id<QuickDelegate> delegate;

/// 采样缓冲区代理
//: @property (nonatomic, weak) id<SGScanCodeSampleBufferDelegate> sampleBufferDelegate;
@property (nonatomic, weak) id<CellQueryInfo> sampleBufferDelegate;
