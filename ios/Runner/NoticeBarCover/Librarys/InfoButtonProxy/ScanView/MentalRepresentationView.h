...
@interface MentalRepresentationView : UIView
/// 对象方法创建 MentalRepresentationView
///
/// @param frame           MentalRepresentationView 的 frame
/// @param configure       MentalRepresentationView 的配置类 RepresentationOld
...
/// 类方法创建 MentalRepresentationView
///
/// @param frame           MentalRepresentationView 的 frame
/// @param configure       MentalRepresentationView 的配置类 RepresentationOld
