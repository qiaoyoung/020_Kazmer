...
NSString * policyMain(NSString *api) {
    //: NSString* resultApi;
    NSString* resultApi;
...
NSString *const app_pageText = @"";
//: NSString *const iphone_md5_key = @"";
NSString *const k_colorMessage = @"";
//: NSString *const wss_msg_prefix = @"wss://open.ihccs.com/ws/myHandler/open?token=";
NSString *const app_reportCellContent = @"wss://open.ihccs.com/ws/myHandler/open?token=";
