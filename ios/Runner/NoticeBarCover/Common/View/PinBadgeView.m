...
@implementation PinBadgeView

//: + (instancetype)viewWithBadgeTip:(NSString *)badgeValue{
+ (instancetype)session:(NSString *)badgeValue{
    //: if (!badgeValue) {
    if (!badgeValue) {
        //: badgeValue = @"";
        badgeValue = @"";
    ...
    PinBadgeView *instance = [[PinBadgeView alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance filterEnable:badgeValue];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self contextOfUseKey:rect parameter:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self letterContainer:rect along:context];
    }
...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    self.frame = [self filterEnable:badgeValue];
...
- (CGSize)ting:(NSString *)badgeValue{
...
- (CGRect)filterEnable:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self ting:badgeValue];
...
- (void)contextOfUseKey:(CGRect)rect parameter:(CGContextRef)context{
...
- (void)letterContainer:(CGRect)rect along:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;
