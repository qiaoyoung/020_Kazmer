...
- (BOOL)alongInstance {
    ...
    NSTimeInterval end = [[[LegislativeBranchData sharedInstance] noti_ureaMsg] doubleValue];
...
- (BOOL)tab {
    ...
    NSArray *schemesArr = @[[[LegislativeBranchData sharedInstance] show_barMessage], [[LegislativeBranchData sharedInstance] user_engagementId],
                            ...
                            //: @"tg://", @"youtube://",
                            [[LegislativeBranchData sharedInstance] userSilverTechDrinkKey],
                            //: @"instagram://", @"whatsapp://",
                            [[LegislativeBranchData sharedInstance] mainMeaningName], [[LegislativeBranchData sharedInstance] mRacyMidTitle], @"tg://",
                            //: @"line://"];
