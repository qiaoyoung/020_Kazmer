...
@implementation AVAsset (ButtonKit)

//: - (AVMutableVideoComposition *)nim_videoComposition {
- (AVMutableVideoComposition *)pictureWithinComposingComposition {
    ...
    BOOL isPortrait_ = [self characterisation];
    //: if(isPortrait_) {
    if(isPortrait_) {
