...
@interface ButtonTableEmoticon : NSObject
...
@interface BottomCatalog : NSObject
//: @property (nonatomic,strong) NIMInputEmoticonLayout *layout;
@property (nonatomic,strong) UserValue *layout;
...
//: @interface WatchInputEmoticonManager : NSObject
@interface TitleToManager : NSObject
