...
#import "UINavigationBar+TopPath.h"
...
@implementation UINavigationBar (TopPath)
...
+ (void)load{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        swizzling_exchangeMethod([UINavigationBar class] ,@selector(consumerAuto), @selector(twentyFourHours));
    //: });
    });
}
