...
//  github : https://github.com/biggercoffee/Titles
//
...
static inline void restoreDate(Class class, SEL originalSelector, SEL swizzledSelector) {
...
@implementation NSString (Titles)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        restoreDate(class, @selector(description), @selector(replyHeight));
        //: zxp_swizzleSelector(class, @selector(descriptionWithLocale:), @selector(zxp_descriptionWithLocale:));
        restoreDate(class, @selector(descriptionWithLocale:), @selector(beggarMyNeighborPolicy:));
        //: zxp_swizzleSelector(class, @selector(descriptionWithLocale:indent:), @selector(zxp_descriptionWithLocale:indent:));
        restoreDate(class, @selector(descriptionWithLocale:indent:), @selector(light:jobDescriptionTing:));
    //: });
    });
}
...
@implementation NSDictionary (Titles)
