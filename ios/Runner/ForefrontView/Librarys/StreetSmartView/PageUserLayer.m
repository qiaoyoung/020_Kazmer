...
static CGFloat const showCommentData = 3;

//: @implementation YasicClipAreaLayer
@implementation PageUserLayer
...
- (void)drawInContext:(CGContextRef)ctx
{
    ...
    CGContextSetLineWidth(ctx, showCommentData);
...
- (void)minTouch:(NSInteger)cropAreaLeft view:(NSInteger)cropAreaTop change:(NSInteger)cropAreaRight sinceView:(NSInteger)cropAreaBottom
{
    //: _cropAreaLeft = cropAreaLeft;
    _cropAreaLeft = cropAreaLeft;
    //: _cropAreaRight = cropAreaRight;
