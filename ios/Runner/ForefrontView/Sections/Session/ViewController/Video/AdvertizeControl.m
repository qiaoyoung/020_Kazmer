...
@implementation AdvertizeControl
{
    //: CGRect _frame;
    CGRect _frame;
}
...
- (void)ground{
    ...
    self.thumb.center = [self model:_value];
...
- (void)setBufferProgress:(CGFloat)bufferProgress{
    ...
    bufferProgress = [self label:bufferProgress];
...
- (void)center:(UIImage *)thumbImage end:(UIControlState)state{
