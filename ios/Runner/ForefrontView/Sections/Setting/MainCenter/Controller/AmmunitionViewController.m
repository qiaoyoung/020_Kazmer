...
NSString *StringFromFierceData(Byte *data);


//: zh-Hant
Byte kTextMoleValue[] = {54, 7, 59, 6, 191, 33, 181, 163, 104, 131, 156, 169, 175, 100};

//: icon_photo
Byte kTitleButName[] = {81, 10, 19, 14, 244, 212, 239, 91, 76, 13, 15, 238, 14, 252, 124, 118, 130, 129, 114, 131, 123, 130, 135, 130, 35};

//: warm_prompt
Byte kTextButValue[] = {5, 11, 82, 14, 131, 49, 188, 242, 137, 99, 209, 79, 3, 28, 201, 179, 196, 191, 177, 194, 196, 193, 191, 194, 198, 4};

//: icon_me_arrow
Byte kText_monthTeamName[] = {81, 13, 17, 14, 161, 10, 228, 108, 204, 222, 203, 205, 18, 86, 122, 116, 128, 127, 112, 126, 118, 112, 114, 131, 131, 128, 136, 163};

//: setting_privacy
Byte kText_hideData[] = {87, 15, 62, 8, 30, 158, 156, 3, 177, 163, 178, 178, 167, 172, 165, 157, 174, 176, 167, 180, 159, 161, 183, 227};

//: user_profile_avtivity_account
Byte kName_inevitablyValue[] = {41, 29, 78, 8, 158, 222, 180, 48, 195, 193, 179, 192, 173, 190, 192, 189, 180, 183, 186, 179, 173, 175, 196, 194, 183, 196, 183, 194, 199, 173, 175, 177, 177, 189, 195, 188, 194, 109};

//: my_user_info_activity_title
Byte kText_contentData[] = {37, 27, 92, 8, 35, 113, 81, 27, 201, 213, 187, 209, 207, 193, 206, 187, 197, 202, 194, 203, 187, 189, 191, 208, 197, 210, 197, 208, 213, 187, 208, 197, 208, 200, 193, 143};

//: account_gender
Byte kName_chickTitle[] = {24, 14, 73, 12, 254, 19, 240, 203, 92, 228, 94, 204, 170, 172, 172, 184, 190, 183, 189, 168, 176, 174, 183, 173, 174, 187, 14};

//: user_id
Byte kTitleViolationData[] = {32, 7, 82, 6, 108, 85, 199, 197, 183, 196, 177, 187, 182, 123};

//: code
Byte kTitleTopThoughString[] = {82, 4, 64, 8, 36, 100, 187, 194, 163, 175, 164, 165, 204};

//: icon_options_grdefault
Byte kContentDoingValue[] = {65, 22, 63, 7, 69, 182, 185, 168, 162, 174, 173, 158, 174, 175, 179, 168, 174, 173, 178, 158, 166, 177, 163, 164, 165, 160, 180, 171, 179, 162};

//: contact_tag_fragment_cancel
Byte kTitle_currentString[] = {69, 27, 91, 14, 242, 64, 215, 35, 204, 156, 153, 219, 48, 67, 190, 202, 201, 207, 188, 190, 207, 186, 207, 188, 194, 186, 193, 205, 188, 194, 200, 192, 201, 207, 186, 190, 188, 201, 190, 192, 199, 68};

//: zh-Hans
Byte kTitleLastNimValue[] = {97, 7, 5, 5, 196, 127, 109, 50, 77, 102, 115, 120, 186};

//: /user/edit
Byte kTitle_chickData[] = {30, 10, 8, 6, 40, 69, 55, 125, 123, 109, 122, 55, 109, 108, 113, 124, 216};

//: group_info_activity_update_failed
Byte kText_redValue[] = {28, 33, 7, 4, 110, 121, 118, 124, 119, 102, 112, 117, 109, 118, 102, 104, 106, 123, 112, 125, 112, 123, 128, 102, 124, 119, 107, 104, 123, 108, 102, 109, 104, 112, 115, 108, 107, 77};

//: accout_nickname
Byte kName_currentValue[] = {70, 15, 10, 13, 204, 43, 104, 174, 120, 238, 255, 111, 7, 107, 109, 109, 121, 127, 126, 105, 120, 115, 109, 117, 120, 107, 119, 111, 7};

//: user_info_avtivity_upload_avatar_failed
Byte kTitleShowValue[] = {27, 39, 20, 5, 94, 137, 135, 121, 134, 115, 125, 130, 122, 131, 115, 117, 138, 136, 125, 138, 125, 136, 141, 115, 137, 132, 128, 131, 117, 120, 115, 117, 138, 117, 136, 117, 134, 115, 122, 117, 125, 128, 121, 120, 30};

//: friend_info_activity_nan
Byte kTitle_sharedData[] = {34, 24, 70, 10, 187, 11, 213, 103, 35, 159, 172, 184, 175, 171, 180, 170, 165, 175, 180, 172, 181, 165, 167, 169, 186, 175, 188, 175, 186, 191, 165, 180, 167, 180, 97};

//: friend_info_activity_xu
Byte kTextThoughString[] = {67, 23, 98, 10, 91, 8, 241, 4, 171, 196, 200, 212, 203, 199, 208, 198, 193, 203, 208, 200, 209, 193, 195, 197, 214, 203, 216, 203, 214, 219, 193, 218, 215, 253};

//: ko-KP
Byte kTitleFileValue[] = {23, 5, 79, 6, 20, 99, 186, 190, 124, 154, 159, 80};

//: activity_friend_info_sex
Byte kContent_colorString[] = {26, 24, 23, 13, 23, 76, 239, 180, 211, 70, 63, 167, 77, 120, 122, 139, 128, 141, 128, 139, 144, 118, 125, 137, 128, 124, 133, 123, 118, 128, 133, 125, 134, 118, 138, 124, 143, 224};

//: tag_activity_set
Byte kTitle_tapValue[] = {39, 16, 89, 7, 245, 210, 254, 205, 186, 192, 184, 186, 188, 205, 194, 207, 194, 205, 210, 184, 204, 190, 205, 176};

//: back_arrow_bl
Byte kName_lastValue[] = {74, 13, 24, 4, 122, 121, 123, 131, 119, 121, 138, 138, 135, 143, 119, 122, 132, 116};

//: friend_info_activity_nv
Byte kTitleEndReservationValue[] = {63, 23, 48, 13, 20, 77, 252, 182, 210, 202, 197, 58, 118, 150, 162, 153, 149, 158, 148, 143, 153, 158, 150, 159, 143, 145, 147, 164, 153, 166, 153, 164, 169, 143, 158, 166, 88};

//: jpg
Byte kTitleTextData[] = {42, 3, 65, 6, 228, 65, 171, 177, 168, 171};

//: spa
Byte kContent_toothValue[] = {63, 3, 38, 9, 20, 173, 84, 25, 28, 153, 150, 135, 185};

//: setting_privacy_camera
Byte kTextLastString[] = {35, 22, 88, 13, 224, 203, 77, 114, 68, 39, 119, 143, 242, 203, 189, 204, 204, 193, 198, 191, 183, 200, 202, 193, 206, 185, 187, 209, 183, 187, 185, 197, 189, 202, 185, 20};

//: photo_account_def
Byte kNameCountactValue[] = {13, 17, 13, 4, 125, 117, 124, 129, 124, 108, 110, 112, 112, 124, 130, 123, 129, 108, 113, 114, 115, 11};

//: #5D5F66
Byte kText_modelString[] = {81, 7, 48, 13, 61, 62, 212, 81, 251, 250, 12, 132, 32, 83, 101, 116, 101, 118, 102, 102, 170};

//: activity_my_user_info_nick
Byte kNamePlaceString[] = {51, 26, 8, 10, 113, 166, 243, 232, 11, 84, 105, 107, 124, 113, 126, 113, 124, 129, 103, 117, 129, 103, 125, 123, 109, 122, 103, 113, 118, 110, 119, 103, 118, 113, 107, 115, 153};

//: account_account
Byte kTitleNonprofitValue[] = {55, 15, 73, 11, 141, 179, 205, 149, 87, 171, 176, 170, 172, 172, 184, 190, 183, 189, 168, 170, 172, 172, 184, 190, 183, 189, 126};

//: userinfo_bg
Byte kNameShowData[] = {20, 11, 73, 8, 76, 139, 120, 148, 190, 188, 174, 187, 178, 183, 175, 184, 168, 171, 176, 206};

//: /user/detail
Byte kName_porchValue[] = {65, 12, 27, 6, 124, 249, 74, 144, 142, 128, 141, 74, 127, 128, 143, 124, 132, 135, 205};

//: icon_copy
Byte kTextSharedData[] = {57, 9, 81, 12, 143, 248, 44, 161, 210, 49, 43, 90, 186, 180, 192, 191, 176, 180, 192, 193, 202, 3};

//: hant
Byte kTextCurrentData[] = {90, 4, 71, 5, 103, 175, 168, 181, 187, 39};

// __DEBUG__
// __CLOSE_PRINT__
//
//  AmmunitionViewController.m
//  Riverla
//
...
- (void)light {
    ...
    [self.imgHeader sd_setImageWithURL:[NSURL URLWithString:me.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromFierceData(kContentDoingValue)]];
...
//    self.sign.text = me.userInfo.sign.length ? me.userInfo.sign : LangKey(@"未设置");
    ...
    self.sex.text = [self scaleCell:me.userInfo.gender];

    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"user_id"] = me.userId;
    dict[StringFromFierceData(kTitleViolationData)] = me.userId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [BlendView read:[NSString stringWithFormat:StringFromFierceData(kName_porchValue)] query:dict showThan:NO green:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict comment:StringFromFierceData(kTitleTopThoughString)];
...
//    self.view.backgroundColor = RGB_COLOR_String(@"#F6F7FA");
    ...
    bg.image = [UIImage imageNamed:StringFromFierceData(kNameShowData)];
    ...
    [backButton setImage:[UIImage imageNamed:StringFromFierceData(kName_lastValue)] forState:(UIControlStateNormal)];
...
- (void)completeSex
{
    ...
    [self.sexView enable: self.selectedGender];
    //: [self.sexView animationShow];
    [self.sexView exhibit];
    @
...
- (void)visible:(UIImage *)image{
    ...
    NSString *fileName = [DisplayHelper should:StringFromFierceData(kTitleTextData)];
...
- (void)labelLabel
{
    ...
    [ self.changeNickNameView insert: self.nickName.text];
    //: [self.changeNickNameView animationShow];
    [self.changeNickNameView name];
}
/**
 *  请求相机权限
 */
...
- (void)overName:(UIImagePickerControllerSourceType)type{
...
- (void)text
{
    ...
    YrViewController *vc = [[YrViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)success{
    ...
    [BlendView read:[NSString stringWithFormat:StringFromFierceData(kTitle_chickData)] query:dict showThan:YES green:^(id responseObject) {

        //: [wself.sexView animationClose];
        [wself.sexView ingatheringBy];
    //: } failed:^(id responseObject, NSError *error) {
    } blue:^(id responseObject, NSError *error) {
    ...
    self.sex.text = [self scaleCell:self.selectedGender];
...
- (NSString *)scaleCell:(NSInteger )gender{
    //: NSString *genderStr = @"";
    NSString *genderStr = @"";
    //: switch (gender) {
    switch (gender) {
...
- (void)atFile
{
    ...
    UIView *avaterView = [[UIView alloc]initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-140)/2, (44.0f + [UIDevice comeDownSuperphylum])+15, 140, 140)];
    ...
    self.imgHeader.image = [UIImage imageNamed:StringFromFierceData(kNameCountactValue)];
...
//    self.btnPhoto.backgroundColor = [UIColor whiteColor];
    ...
    [self.btnPhoto setImage:[UIImage imageNamed:StringFromFierceData(kTitleButName)] forState:(UIControlStateNormal)];
    //: [self.btnPhoto addTarget:self action:@selector(handleThePhoto) forControlEvents:UIControlEventTouchUpInside];
    [self.btnPhoto addTarget:self action:@selector(streetSmart) forControlEvents:UIControlEventTouchUpInside];
    ...
    accountImg.image = [UIImage imageNamed:StringFromFierceData(kTitleNonprofitValue)];
    ...
    self.account.textColor = [UIColor cell:StringFromFierceData(kText_modelString)];
    ...
    [self.btnCopy setImage:[UIImage imageNamed:StringFromFierceData(kTextSharedData)] forState:(UIControlStateNormal)];
    //: [self.btnCopy addTarget:self action:@selector(handleTheCopy) forControlEvents:UIControlEventTouchUpInside];
    [self.btnCopy addTarget:self action:@selector(pinFor) forControlEvents:UIControlEventTouchUpInside];
    ...
    UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(labelLabel)];
    ...
    nameImg.image = [UIImage imageNamed:StringFromFierceData(kName_currentValue)];
...
//    labtitle.textAlignment = NSTextAlignmentCenter;
    ...
    self.nickName.textColor = [UIColor cell:StringFromFierceData(kText_modelString)];
    ...
    arrow.image = [UIImage imageNamed:StringFromFierceData(kText_monthTeamName)];
    ...
    UITapGestureRecognizer *sexGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(completeSex)];
    ...
    sexImg.image = [UIImage imageNamed:StringFromFierceData(kName_chickTitle)];
...
//    labtitle.textAlignment = NSTextAlignmentCenter;
    ...
    self.sex.textColor = [UIColor cell:StringFromFierceData(kText_modelString)];
    ...
    sexarrow.image = [UIImage imageNamed:StringFromFierceData(kText_monthTeamName)];
...
- (ReposeCornerView *)changeNickNameView
{
    ...
    if(!_changeNickNameView){
        ...
        _changeNickNameView = [[ReposeCornerView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
//    imagePickerVc.naviBgColor = [KEKESkinColorManager shareInstance].skinColor;
    ...
    //: }else if ([langType containsString:@"ko"]){
        ...
        //: preferredlang = @"ko-KP";
        preferredlang = StringFromFierceData(kTitleFileValue);
    //: }else if ([langType containsString:@"spa"]){
    }else if ([langType containsString:StringFromFierceData(kContent_toothValue)]){
        //: preferredlang = @"es";
        preferredlang = @"es";
    ...
    //: }else if ([langType containsString:@"zh"]){
        ...
        preferredlang = StringFromFierceData(kTitleLastNimValue);
    ...
    }else if ([langType containsString:StringFromFierceData(kTextCurrentData)]){
        //: preferredlang = @"zh-Hant";
        preferredlang = StringFromFierceData(kTextMoleValue);
    //: }else{
    }else{
        //: preferredlang = @"en";
        preferredlang = @"en";
...
#pragma mark - 到这里为止
    ...
    [imagePickerVc setDidFinishPickingPhotosHandle:^(NSArray<UIImage *> *photos, NSArray *assets, BOOL isSelectOriginalPhoto) {
        ...
        if (photos.count > 0 && assets.count > 0) {
            ...
            [self visible:photos.firstObject];
        }
    //: }];
    }];
...
- (void)bubbleWith:(NSInteger )tag
{
    ...
    if(tag == 101){
        ...
        [self overName:UIImagePickerControllerSourceTypeCamera];
    //: }else if (tag == 102){
    }else if (tag == 102){
        //: [self showImagePicker:UIImagePickerControllerSourceTypePhotoLibrary];
        [self overName:UIImagePickerControllerSourceTypePhotoLibrary];
    }
}
...
- (ToNameView *)sexView
{
    ...
    if(!_sexView){
        ...
        _sexView = [[ToNameView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
//        _sexView.hidden = YES;
    }
    //: return _sexView;
    return _sexView;
...
Byte * FierceDataToCache(Byte *data) {
    int depth = data[0];
    int placeCurrent = data[1];
    Byte compartment = data[2];
    int pinCurrent = data[3];
    if (!depth) return data + pinCurrent;
    for (int i = pinCurrent; i < pinCurrent + placeCurrent; i++) {
        int value = data[i] - compartment;
        if (value < 0) {
            value += 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[pinCurrent + placeCurrent] = 0;
    return data + pinCurrent;
}

NSString *StringFromFierceData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)FierceDataToCache(data)];
}
