...
@interface FlushManager : NSObject
...
- (void)noContacts:(void (^)(BOOL succeed, NSArray <WithPerson *> *contacts, NSArray <NSString *> *keys))completcion;
...
- (void)pressed:(void (^)(BOOL succeed, NSArray <MakePerson *> *contacts))completcion;

//: + (instancetype)sharedInstance;;
+ (instancetype)outView;
/**
 请求授权
