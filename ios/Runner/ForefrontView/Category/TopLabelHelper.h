 ...
 *
 * 如果您在使用 TopLabelHelper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
@interface TopLabelHelper : NSObject
...
+ (__kindof NSURLSessionTask *)language:(NSString *)URL
 ...
 */
//: + (__kindof NSURLSessionTask *)GET:(NSString *)URL
+ (__kindof NSURLSessionTask *)send:(NSString *)URL
                        //: parameters:(id)parameters
                        press:(id)parameters
...
+ (__kindof NSURLSessionTask *)outpostMax:(NSString *)URL
                         //: parameters:(id)parameters
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)viewRange:(NSString *)URL
                         //: parameters:(id)parameters
                         tip:(id)parameters
                      //: responseCache:(YLHttpRequestCache)responseCache
...
+ (__kindof NSURLSessionTask *)tip:(NSString *)URL
                                      //: parameters:(id)parameters
                                      key:(id)parameters
                                            //: name:(NSString *)name
...
+ (__kindof NSURLSessionTask *)uploadInNonachievement:(NSString *)URL
                                       //: parameters:(id)parameters
                                       honkyTonkData:(id)parameters
                                             //: name:(NSString *)name
                                             invite:(NSString *)name
                                             //: data:(NSData *)data
                                             falseTextFailure:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         denomination:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        bubble:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         can:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          toFailure:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          touch:(YLHttpRequestFailed)failure;
...
+ (__kindof NSURLSessionTask *)showFailure:(NSString *)URL
                                        //: parameters:(id)parameters
                                        to:(id)parameters
                                              //: name:(NSString *)name
...
+ (__kindof NSURLSessionTask *)providerFailure:(NSString *)URL
                                       //: fileDir:(NSString *)fileDir
                                       occurrentOf:(NSString *)fileDir
                                      //: progress:(YLHttpProgress)progress
                                      numberHttpProgress:(YLHttpProgress)progress
                                       //: success:(void(^)(NSString *filePath))success
                                       threadEnable:(void(^)(NSString *filePath))success
                                       //: failure:(YLHttpRequestFailed)failure;
...
+ (void)setPerchDownwardSessionProperty:(void(^)(AFHTTPSessionManager *sessionManager))sessionManager;
