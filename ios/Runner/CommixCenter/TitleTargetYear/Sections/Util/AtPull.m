...
NSString *StringFromFireRaisingData(Byte *data);        


//: yesterday
Byte kNameDayString[] = {56, 9, 35, 6, 167, 190, 86, 66, 80, 81, 66, 79, 65, 62, 86, 239};

//: message_modification_permissions
Byte kNameProvedData[] = {58, 32, 79, 13, 184, 69, 101, 93, 253, 102, 184, 215, 159, 30, 22, 36, 36, 18, 24, 22, 16, 30, 32, 21, 26, 23, 26, 20, 18, 37, 26, 32, 31, 16, 33, 22, 35, 30, 26, 36, 36, 26, 32, 31, 36, 204};

//: app_avchat_cancel
Byte kTitle_fistValue[] = {60, 17, 67, 13, 207, 162, 4, 68, 181, 200, 166, 30, 217, 30, 45, 45, 28, 30, 51, 32, 37, 30, 49, 28, 32, 30, 43, 32, 34, 41, 203};

//: message_been_lifted
Byte kNameStableString[] = {80, 19, 96, 10, 147, 202, 40, 20, 46, 67, 13, 5, 19, 19, 1, 7, 5, 255, 2, 5, 5, 14, 255, 12, 9, 6, 20, 5, 4, 215};

//: message_group_administrator
Byte kText_fishRatherIronValue[] = {8, 27, 18, 6, 80, 129, 91, 83, 97, 97, 79, 85, 83, 77, 85, 96, 93, 99, 94, 77, 79, 82, 91, 87, 92, 87, 97, 98, 96, 79, 98, 93, 96, 82};

//: message_proclamation
Byte kText_suspicionData[] = {12, 20, 57, 14, 83, 56, 184, 234, 192, 191, 123, 148, 187, 204, 52, 44, 58, 58, 40, 46, 44, 38, 55, 57, 54, 42, 51, 40, 52, 40, 59, 48, 54, 53, 70};

//: message_leave
Byte kName_twistSubData[] = {19, 13, 51, 13, 53, 169, 163, 173, 195, 247, 19, 184, 80, 58, 50, 64, 64, 46, 52, 50, 44, 57, 50, 46, 67, 50, 193};

//: message_people
Byte kTextChopArtiString[] = {16, 14, 5, 13, 237, 87, 48, 34, 191, 26, 251, 184, 36, 104, 96, 110, 110, 92, 98, 96, 90, 107, 96, 106, 107, 103, 96, 51};

//: app_avchat_has_reject
Byte kName_packData[] = {72, 21, 93, 10, 207, 60, 95, 251, 169, 225, 4, 19, 19, 2, 4, 25, 6, 11, 4, 23, 2, 11, 4, 22, 2, 21, 8, 13, 8, 6, 23, 165};

//: Friday
Byte kTextCurrentValue[] = {66, 6, 17, 5, 245, 53, 97, 88, 83, 80, 104, 240};

//: message_removed_blacklist_administrator
Byte kTitleEyebrowString[] = {15, 39, 7, 4, 102, 94, 108, 108, 90, 96, 94, 88, 107, 94, 102, 104, 111, 94, 93, 88, 91, 101, 90, 92, 100, 101, 98, 108, 109, 88, 90, 93, 102, 98, 103, 98, 108, 109, 107, 90, 109, 104, 107, 234};

//: message_dismissed_admin
Byte kNameHoweverData[] = {46, 23, 5, 7, 147, 23, 34, 104, 96, 110, 110, 92, 98, 96, 90, 95, 100, 110, 104, 100, 110, 110, 96, 95, 90, 92, 95, 104, 100, 105, 173};

//: day_pm
Byte kTitle_gearSnapGentData[] = {5, 6, 87, 7, 107, 163, 47, 13, 10, 34, 8, 25, 22, 20};

//: Thursday
Byte kTextPromptCombatName[] = {4, 8, 71, 5, 177, 13, 33, 46, 43, 44, 29, 26, 50, 240};

//: message_dismissed_member_identity
Byte kText_penalClerkNightmareData[] = {72, 33, 20, 11, 241, 244, 194, 169, 98, 16, 91, 89, 81, 95, 95, 77, 83, 81, 75, 80, 85, 95, 89, 85, 95, 95, 81, 80, 75, 89, 81, 89, 78, 81, 94, 75, 85, 80, 81, 90, 96, 85, 96, 101, 220};

//: message_removed_room
Byte kNameShowContent[] = {67, 20, 60, 6, 90, 32, 49, 41, 55, 55, 37, 43, 41, 35, 54, 41, 49, 51, 58, 41, 40, 35, 54, 51, 51, 49, 16};

//: message_permissions_updated
Byte kContent_data[] = {55, 27, 74, 14, 80, 40, 200, 70, 207, 55, 106, 113, 186, 15, 35, 27, 41, 41, 23, 29, 27, 21, 38, 27, 40, 35, 31, 41, 41, 31, 37, 36, 41, 21, 43, 38, 26, 23, 42, 27, 26, 157};

//: Saturday
Byte kNameWrapString[] = {1, 8, 47, 8, 179, 222, 166, 23, 36, 50, 69, 70, 67, 53, 50, 74, 183};

//: message_accept
Byte kTitleEtcName[] = {26, 14, 58, 4, 51, 43, 57, 57, 39, 45, 43, 37, 39, 41, 41, 43, 54, 58, 248};

//: day_am
Byte kTextDenseName[] = {1, 6, 24, 11, 61, 143, 181, 27, 196, 185, 35, 76, 73, 97, 71, 73, 85, 97};

//: message_administrator_speak
Byte kName_flowerString[] = {82, 27, 60, 14, 255, 175, 250, 153, 182, 23, 252, 2, 99, 225, 49, 41, 55, 55, 37, 43, 41, 35, 37, 40, 49, 45, 50, 45, 55, 56, 54, 37, 56, 51, 54, 35, 55, 52, 41, 37, 47, 136};

//: message_verification_mode
Byte kContent_axData[] = {21, 25, 96, 6, 211, 1, 13, 5, 19, 19, 1, 7, 5, 255, 22, 5, 18, 9, 6, 9, 3, 1, 20, 9, 15, 14, 255, 13, 15, 4, 5, 248};

//: message_introduce
Byte kNameRuralDisturbString[] = {31, 17, 38, 11, 20, 151, 126, 71, 234, 28, 14, 71, 63, 77, 77, 59, 65, 63, 57, 67, 72, 78, 76, 73, 62, 79, 61, 63, 228};

//: message_room_closed
Byte kNameEyebrowBullString[] = {55, 19, 65, 13, 103, 20, 151, 115, 114, 156, 216, 57, 187, 44, 36, 50, 50, 32, 38, 36, 30, 49, 46, 46, 44, 30, 34, 43, 46, 50, 36, 35, 249};

//: message_name
Byte kTitle_tribeData[] = {86, 12, 3, 10, 88, 248, 24, 220, 106, 73, 106, 98, 112, 112, 94, 100, 98, 92, 107, 94, 106, 98, 9};

//: online_state_event_manager_unknown
Byte kText_wortName[] = {96, 34, 9, 7, 227, 14, 59, 102, 101, 99, 96, 101, 92, 86, 106, 107, 88, 107, 92, 86, 92, 109, 92, 101, 107, 86, 100, 88, 101, 88, 94, 92, 105, 86, 108, 101, 98, 101, 102, 110, 101, 183};

//: message_information
Byte kText_appointedData[] = {44, 19, 85, 8, 210, 153, 82, 245, 24, 16, 30, 30, 12, 18, 16, 10, 20, 25, 17, 26, 29, 24, 12, 31, 20, 26, 25, 213};

//: message_transferred_group_master
Byte kNameCationData[] = {46, 32, 77, 5, 179, 32, 24, 38, 38, 20, 26, 24, 18, 39, 37, 20, 33, 38, 25, 24, 37, 37, 24, 23, 18, 26, 37, 34, 40, 35, 18, 32, 20, 38, 39, 24, 37, 105};

//: message_group_revoked
Byte kText_ruralDiaryAppointedName[] = {94, 21, 23, 12, 71, 232, 204, 173, 154, 82, 35, 5, 86, 78, 92, 92, 74, 80, 78, 72, 80, 91, 88, 94, 89, 72, 91, 78, 95, 88, 84, 78, 77, 200};

//: message_forbidden_speech
Byte kNameEyebrowHerbString[] = {51, 24, 92, 9, 27, 16, 126, 112, 6, 17, 9, 23, 23, 5, 11, 9, 3, 10, 19, 22, 6, 13, 8, 8, 9, 18, 3, 23, 20, 9, 9, 7, 12, 146};

//: message_call_receiving
Byte kNameDayValue[] = {96, 22, 81, 10, 60, 91, 112, 16, 91, 63, 28, 20, 34, 34, 16, 22, 20, 14, 18, 16, 27, 27, 14, 33, 20, 18, 20, 24, 37, 24, 29, 22, 122};

//: message_helper_already_no
Byte kTitleStableStepName[] = {43, 25, 50, 11, 112, 119, 17, 152, 83, 211, 63, 59, 51, 65, 65, 47, 53, 51, 45, 54, 51, 58, 62, 51, 64, 45, 47, 58, 64, 51, 47, 50, 71, 45, 60, 61, 149};

//: Tuesday
Byte kTitleSymbolData[] = {12, 7, 96, 14, 11, 188, 67, 134, 159, 190, 121, 47, 78, 232, 244, 21, 5, 19, 4, 1, 25, 214};

//: Wednesday
Byte kTextTonightData[] = {99, 9, 89, 5, 114, 254, 12, 11, 21, 12, 26, 11, 8, 32, 106};

//: message_move_out
Byte kName_okayData[] = {84, 16, 53, 7, 246, 42, 153, 56, 48, 62, 62, 44, 50, 48, 42, 56, 58, 65, 48, 42, 58, 64, 63, 5};

//: message_blacklisted_administrator
Byte kName_multipleViewValue[] = {17, 33, 70, 5, 243, 39, 31, 45, 45, 27, 33, 31, 25, 28, 38, 27, 29, 37, 38, 35, 45, 46, 31, 30, 25, 27, 30, 39, 35, 40, 35, 45, 46, 44, 27, 46, 41, 44, 95};

//: message_temporarily_muted
Byte kTitleInevitablyText[] = {13, 25, 14, 4, 95, 87, 101, 101, 83, 89, 87, 81, 102, 87, 95, 98, 97, 100, 83, 100, 91, 94, 107, 81, 95, 103, 102, 87, 86, 201};

//: message_super_team
Byte kNameBraString[] = {54, 18, 17, 5, 245, 92, 84, 98, 98, 80, 86, 84, 78, 98, 100, 95, 84, 97, 78, 99, 84, 80, 92, 162};

//: message_helper_you
Byte kTextGreenContent[] = {61, 18, 49, 12, 87, 43, 152, 195, 147, 7, 239, 137, 60, 52, 66, 66, 48, 54, 52, 46, 55, 52, 59, 63, 52, 65, 46, 72, 62, 68, 227};

//: message_dismissed
Byte kTitleHarassmentExceptData[] = {76, 17, 9, 9, 115, 52, 156, 202, 228, 100, 92, 106, 106, 88, 94, 92, 86, 91, 96, 106, 100, 96, 106, 106, 92, 91, 233};

//: Monday
Byte kNameLiteralHardwareValue[] = {62, 6, 16, 8, 58, 174, 19, 12, 61, 95, 94, 84, 81, 105, 130};

//: contact_my_group_activity_title
Byte kText_magSilkMysteryString[] = {85, 31, 74, 8, 136, 198, 206, 253, 25, 37, 36, 42, 23, 25, 42, 21, 35, 47, 21, 29, 40, 37, 43, 38, 21, 23, 25, 42, 31, 44, 31, 42, 47, 21, 42, 31, 42, 34, 27, 171};

//: message_banned_post
Byte kTitlePosterJoinString[] = {74, 19, 6, 8, 41, 68, 224, 149, 103, 95, 109, 109, 91, 97, 95, 89, 92, 91, 104, 104, 95, 94, 89, 106, 105, 109, 110, 37};

//: Sunday
Byte kName_teamForeignerValue[] = {42, 6, 34, 5, 88, 49, 83, 76, 66, 63, 87, 243};

//: message_enter
Byte kTitleColorFileData[] = {71, 13, 52, 9, 4, 4, 57, 75, 19, 57, 49, 63, 63, 45, 51, 49, 43, 49, 58, 64, 49, 62, 57};

//: message_passed
Byte kNameCompareData[] = {98, 14, 89, 10, 28, 59, 174, 190, 90, 205, 20, 12, 26, 26, 8, 14, 12, 6, 23, 8, 26, 26, 12, 11, 112};

//: message_unknown_system_message
Byte kText_accessibleDegreeString[] = {82, 30, 77, 9, 14, 122, 248, 83, 189, 32, 24, 38, 38, 20, 26, 24, 18, 40, 33, 30, 33, 34, 42, 33, 18, 38, 44, 38, 39, 24, 32, 18, 32, 24, 38, 38, 20, 26, 24, 75};

//: app_avchat_no_pick_up
Byte kName_multipleData[] = {55, 21, 66, 6, 234, 182, 31, 46, 46, 29, 31, 52, 33, 38, 31, 50, 29, 44, 45, 29, 46, 39, 33, 41, 29, 51, 46, 247};

//: message_helper_invite
Byte kName_braData[] = {32, 21, 82, 6, 222, 206, 27, 19, 33, 33, 15, 21, 19, 13, 22, 19, 26, 30, 19, 32, 13, 23, 28, 36, 23, 34, 19, 104};

//: wee_hours
Byte kName_migrationValue[] = {30, 9, 60, 6, 41, 6, 59, 41, 41, 35, 44, 51, 57, 54, 55, 229};

//: %zd-%zd-%zd
Byte kTitle_everValue[] = {27, 11, 25, 14, 149, 116, 43, 37, 20, 95, 110, 85, 17, 77, 12, 97, 75, 20, 12, 97, 75, 20, 12, 97, 75, 66};

//: message_welcome
Byte kName_clearlyData[] = {75, 15, 29, 13, 42, 148, 13, 76, 43, 198, 76, 180, 80, 80, 72, 86, 86, 68, 74, 72, 66, 90, 72, 79, 70, 82, 80, 72, 195};

//: message_updated_information
Byte kText_literalUmValue[] = {50, 27, 96, 11, 72, 203, 221, 93, 9, 55, 118, 13, 5, 19, 19, 1, 7, 5, 255, 21, 16, 4, 1, 20, 5, 4, 255, 9, 14, 6, 15, 18, 13, 1, 20, 9, 15, 14, 149};

//: message_appointed_admin
Byte kNameSateData[] = {39, 23, 85, 5, 8, 24, 16, 30, 30, 12, 18, 16, 10, 12, 27, 27, 26, 20, 25, 31, 16, 15, 10, 12, 15, 24, 20, 25, 145};

//: message_head_portrait
Byte kName_threadValue[] = {69, 21, 56, 12, 159, 62, 174, 3, 253, 163, 188, 9, 53, 45, 59, 59, 41, 47, 45, 39, 48, 45, 41, 44, 39, 56, 55, 58, 60, 58, 41, 49, 60, 121};

//: message_unmuted_administrator
Byte kTitle_denseMatData[] = {36, 29, 1, 12, 185, 25, 219, 105, 9, 212, 24, 102, 108, 100, 114, 114, 96, 102, 100, 94, 116, 109, 108, 116, 115, 100, 99, 94, 96, 99, 108, 104, 109, 104, 114, 115, 113, 96, 115, 110, 113, 13};

//: message_remove_banned
Byte kTextLearnData[] = {75, 21, 77, 7, 230, 11, 176, 32, 24, 38, 38, 20, 26, 24, 18, 37, 24, 32, 34, 41, 24, 18, 21, 20, 33, 33, 24, 23, 62};

//: message_access_failure
Byte kNameBoarBeauValue[] = {4, 22, 64, 5, 53, 45, 37, 51, 51, 33, 39, 37, 31, 33, 35, 35, 37, 51, 51, 31, 38, 33, 41, 44, 53, 50, 37, 201};

//: day_night
Byte kName_viewEchoValue[] = {30, 9, 88, 7, 154, 133, 52, 12, 9, 33, 7, 22, 17, 15, 16, 28, 42};

//: message_custom_extension
Byte kTitle_varietyData[] = {63, 24, 66, 12, 199, 35, 57, 244, 125, 245, 253, 115, 43, 35, 49, 49, 31, 37, 35, 29, 33, 51, 49, 50, 45, 43, 29, 35, 54, 50, 35, 44, 49, 39, 45, 44, 36};

//: app_avchat_is_busy_opposite
Byte kTitle_researchString[] = {91, 27, 60, 8, 98, 243, 230, 35, 37, 52, 52, 35, 37, 58, 39, 44, 37, 56, 35, 45, 55, 35, 38, 57, 55, 61, 35, 51, 52, 52, 51, 55, 45, 56, 41, 89};

//: message_invited_into
Byte kTitle_properData[] = {98, 20, 49, 9, 172, 32, 55, 42, 136, 60, 52, 66, 66, 48, 54, 52, 46, 56, 61, 69, 56, 67, 52, 51, 46, 56, 61, 67, 62, 229};

//: message_announcement_updated
Byte kContent_sateLieName[] = {81, 28, 93, 4, 16, 8, 22, 22, 4, 10, 8, 2, 4, 17, 17, 18, 24, 17, 6, 8, 16, 8, 17, 23, 2, 24, 19, 7, 4, 23, 8, 7, 172};

//: message_left_room
Byte kTitleAughtData[] = {21, 17, 48, 13, 37, 244, 250, 114, 162, 193, 225, 254, 94, 61, 53, 67, 67, 49, 55, 53, 47, 60, 53, 54, 68, 47, 66, 63, 63, 61, 178};

//: message_call_duration
Byte kContentHarassmentData[] = {43, 21, 40, 5, 217, 69, 61, 75, 75, 57, 63, 61, 55, 59, 57, 68, 68, 55, 60, 77, 74, 57, 76, 65, 71, 70, 83};

//: message_have_update
Byte kNameDevoteValue[] = {70, 19, 8, 4, 101, 93, 107, 107, 89, 95, 93, 87, 96, 89, 110, 93, 87, 109, 104, 92, 89, 108, 93, 167};

//: message_remove_by
Byte kName_whereverText[] = {73, 17, 9, 11, 46, 142, 136, 51, 140, 156, 87, 100, 92, 106, 106, 88, 94, 92, 86, 105, 92, 100, 102, 109, 92, 86, 89, 112, 179};

//: message_dismiss_whole_mute
Byte kTitleWhereverValue[] = {76, 26, 23, 4, 86, 78, 92, 92, 74, 80, 78, 72, 77, 82, 92, 86, 82, 92, 92, 72, 96, 81, 88, 85, 78, 72, 86, 94, 93, 78, 139};

//: message_changed_room_queue
Byte kNameOffValue[] = {52, 26, 49, 5, 19, 60, 52, 66, 66, 48, 54, 52, 46, 50, 55, 48, 61, 54, 52, 51, 46, 65, 62, 62, 60, 46, 64, 68, 52, 68, 52, 166};

//: message_dismiss_temporary
Byte kName_addedValue[] = {14, 25, 51, 13, 192, 192, 181, 175, 168, 72, 151, 205, 194, 58, 50, 64, 64, 46, 52, 50, 44, 49, 54, 64, 58, 54, 64, 64, 44, 65, 50, 58, 61, 60, 63, 46, 63, 70, 207};

//: message_apply_for
Byte kName_detailValue[] = {89, 17, 31, 6, 54, 239, 78, 70, 84, 84, 66, 72, 70, 64, 66, 81, 81, 77, 90, 64, 71, 80, 83, 224};

//: message_muted_administrator
Byte kName_colorfulSenString[] = {97, 27, 30, 14, 197, 84, 13, 199, 201, 238, 191, 163, 97, 241, 79, 71, 85, 85, 67, 73, 71, 65, 79, 87, 86, 71, 70, 65, 67, 70, 79, 75, 80, 75, 85, 86, 84, 67, 86, 81, 84, 219};

//: message_invite_permission
Byte kTitle_daughterValue[] = {93, 25, 19, 7, 52, 226, 17, 90, 82, 96, 96, 78, 84, 82, 76, 86, 91, 99, 86, 97, 82, 76, 93, 82, 95, 90, 86, 96, 96, 86, 92, 91, 113};

//: message_added_member
Byte kTitleFantasticText[] = {5, 20, 72, 7, 37, 77, 98, 37, 29, 43, 43, 25, 31, 29, 23, 25, 28, 28, 29, 28, 23, 37, 29, 37, 26, 29, 42, 42};
...
+ (NSDateComponentsFormatter *)dismiss {
    //: if (!_dateComponentsFormatter) {
    if (!appCommentRangeName) {
        //: @synchronized (self) {
        @synchronized (self) {
            //: if (!_dateComponentsFormatter) {
            if (!appCommentRangeName) {
                //: _dateComponentsFormatter = [[NSDateComponentsFormatter alloc] init];
                appCommentRangeName = [[NSDateComponentsFormatter alloc] init];
                //: _dateComponentsFormatter.unitsStyle = NSDateComponentsFormatterUnitsStylePositional;
                appCommentRangeName.unitsStyle = NSDateComponentsFormatterUnitsStylePositional;
                //: _dateComponentsFormatter.allowedUnits = NSCalendarUnitHour|NSCalendarUnitMinute|NSCalendarUnitSecond;
                appCommentRangeName.allowedUnits = NSCalendarUnitHour|NSCalendarUnitMinute|NSCalendarUnitSecond;
                //: _dateComponentsFormatter.zeroFormattingBehavior = NSDateComponentsFormatterZeroFormattingBehaviorPad;
                appCommentRangeName.zeroFormattingBehavior = NSDateComponentsFormatterZeroFormattingBehaviorPad;
            }
        }
    }
    //: return _dateComponentsFormatter;
    return appCommentRangeName;
}
...
+ (NSString*)rangeFor:(NIMMessage *)message{
...
+ (NSString *)with:(NSInteger)time color:(NSInteger)minute
{
...
+ (NSString *)cypher:(NSString*)uid bringHomeLikeCipher:(NIMMessage*)message
{
    ...
    return [[Mortification text] tingVoice:uid keepingOption:option].showName;
}

//: + (NSString *)netcallNotificationFormatedMessage:(NIMMessage *)message{
+ (NSString *)language:(NIMMessage *)message{
    //: NIMNotificationObject *object = message.messageObject;
    NIMNotificationObject *object = message.messageObject;
...
+ (NSString *)subName:(NIMMessage *)message{
    //: NSString *source;
    NSString *source;
    //: NIMNotificationObject *object = message.messageObject;
    NIMNotificationObject *object = message.messageObject;
...
+ (NSString *)southwest:(NIMMessage *)message{
    //: NIMNotificationObject *object = message.messageObject;
    NIMNotificationObject *object = message.messageObject;
...
+ (NSArray *)mark:(NIMMessage *)message{
...
+(NSString*)foam:(NSInteger)dayOfWeek
{
...
+ (NSString *)state:(NIMQuickComment *)comment
{
...
+ (NSString *)ting:(NSTimeInterval)seconds
{
    ...
    NSString *text = [[self dismiss] stringFromTimeInterval:seconds];
    //: return text;
    return text;
}
...
+ (NSString *)press:(NIMMessage *)message {
...
+ (NSString*)account:(NSTimeInterval) msglastTime notice:(BOOL)showDetail
{
    ...
    else//显示日期
    {
        ...
        NSString *day = [NSString stringWithFormat:StringFromFireRaisingData(kTitle_everValue), msgDateComponents.year, msgDateComponents.month, msgDateComponents.day];
...
Byte * FireRaisingDataToCache(Byte *data) {
    int addedWrap = data[0];
    int echo = data[1];
    Byte ankleFrag = data[2];
    int ployHistorian = data[3];
    if (!addedWrap) return data + ployHistorian;
    for (int i = ployHistorian; i < ployHistorian + echo; i++) {
        int value = data[i] + ankleFrag;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[ployHistorian + echo] = 0;
    return data + ployHistorian;
}

NSString *StringFromFireRaisingData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)FireRaisingDataToCache(data)];
}
