...
//: @interface DisplayGrowingInternalTextView()
...
//: @implementation DisplayGrowingInternalTextView
...
- (instancetype)initWithFrame:(CGRect)frame textContainer:(NSTextContainer *)textContainer
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(chapterWithNotification:) name:UITextViewTextDidChangeNotification object:self];
    }
    //: return self;
    return self;
}
...
- (void)chapterWithNotification:(NSNotification *)notification
{
    //: [self updatePlaceholder];
    [self allowIn];
}
