...
@implementation NSString (Mortification)

//: - (NSString *)nim_localized {
- (NSString *)disable {
    //: NSString * result = [self nim_localizedWithTable:[MyUserKit sharedKit].languageTable];
    NSString * result = [self container:[Mortification text].languageTable];
    //: return result;
    return result;
}
...
- (NSString *)dataTingPin:(NSBundle *)bundle afterBar:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
...
- (NSString *)container:(NSString *)table {
    //: NSBundle * languageBundle = [MyUserKit sharedKit].languageBundle;
    NSBundle * languageBundle = [Mortification text].languageBundle;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self dataTingPin:languageBundle afterBar:table];
}
