...
#import "UIView+RedOld.h"
//: #import "SwizzlingDefine.h"
#import "SwizzlingDefine.h"

//: @implementation UIView (Swizzling)
@implementation UIView (RedOld)
...
- (UIView *)show:(CGPoint)point humanActivity:(UIEvent *)event
{
    //: UIView *view = [self swizzling_hitTest:point withEvent:event];
    UIView *view = [self show:point humanActivity:event];
    //: if (view) {
    if (view) {
    }
    //: return view;
