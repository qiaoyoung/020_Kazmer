...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    self.frame = [self commence:badgeValue];
...
- (void)cellSum:(CGRect)rect inside:(CGContextRef)context{
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self cellSum:rect inside:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self text:rect model:context];
    }
...
+ (instancetype)success:(NSString *)badgeValue{
    ...
    ControlView *instance = [[ControlView alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance commence:badgeValue];
...
- (void)text:(CGRect)rect model:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;
...
- (CGSize)buttonDisable:(NSString *)badgeValue{
...
- (CGRect)commence:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self buttonDisable:badgeValue];
