...
NSString *StringFromConventData(Byte *data);


//: #EEEEEE
Byte user_mayTitle[] = {8, 7, 13, 40, 18, 241, 219, 153, 67, 244, 252, 12, 205, 69, 69, 69, 69, 69, 69, 35, 50};

//: canAddFriend
Byte mPremiseFormat[] = {69, 12, 5, 255, 125, 100, 110, 101, 105, 114, 70, 100, 100, 65, 110, 97, 99, 132};

//: ic_sex_man
Byte userSeparationTableViewValue[] = {24, 10, 8, 69, 155, 47, 36, 237, 110, 97, 109, 95, 120, 101, 115, 95, 99, 105, 102};

//: func_viewholder_black
Byte user_closeValue[] = {16, 21, 12, 43, 167, 198, 40, 249, 104, 222, 63, 108, 107, 99, 97, 108, 98, 95, 114, 101, 100, 108, 111, 104, 119, 101, 105, 118, 95, 99, 110, 117, 102, 228};

//: message_info_activity_msg_notice
Byte appCombinationIdent[] = {6, 32, 13, 145, 132, 110, 97, 142, 75, 248, 184, 181, 251, 101, 99, 105, 116, 111, 110, 95, 103, 115, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 101, 103, 97, 115, 115, 101, 109, 243};

//: #2C3042
Byte mChangePath[] = {88, 7, 3, 50, 52, 48, 51, 67, 50, 35, 135};

//: ic_card_notice
Byte notiMembershipKey[] = {74, 14, 12, 60, 23, 127, 26, 211, 108, 24, 174, 68, 101, 99, 105, 116, 111, 110, 95, 100, 114, 97, 99, 95, 99, 105, 29};

//: item_data
Byte noti_viewGrandpaMsg[] = {15, 9, 7, 47, 147, 81, 171, 97, 116, 97, 100, 95, 109, 101, 116, 105, 109};

//: invite_you_group
Byte kRegnantFormat[] = {24, 16, 4, 96, 112, 117, 111, 114, 103, 95, 117, 111, 121, 95, 101, 116, 105, 118, 110, 105, 178};

//: friend_delete_fail
Byte dream_viaMessage[] = {45, 18, 6, 180, 31, 121, 108, 105, 97, 102, 95, 101, 116, 101, 108, 101, 100, 95, 100, 110, 101, 105, 114, 102, 208};

//: #4B43DE
Byte userCornerBarStateId[] = {17, 7, 3, 69, 68, 51, 52, 66, 52, 35, 97};
...
//: Group_chat
Byte kRefreshKey[] = {14, 10, 3, 116, 97, 104, 99, 95, 112, 117, 111, 114, 71, 43};

//: contact
Byte showContainerMsg[] = {16, 7, 12, 34, 133, 204, 49, 198, 182, 54, 95, 109, 116, 99, 97, 116, 110, 111, 99, 192};

//: user_info_avtivity_upload_avatar_failed
Byte user_rehabUrl[] = {85, 39, 11, 190, 115, 105, 15, 221, 121, 60, 115, 100, 101, 108, 105, 97, 102, 95, 114, 97, 116, 97, 118, 97, 95, 100, 97, 111, 108, 112, 117, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 111, 102, 110, 105, 95, 114, 101, 115, 117, 189};

//: friend_ids
Byte dreamHostaFormat[] = {86, 10, 7, 87, 251, 219, 248, 115, 100, 105, 95, 100, 110, 101, 105, 114, 102, 145};

//: personCard_bg
Byte main_repairText[] = {25, 13, 7, 44, 11, 129, 55, 103, 98, 95, 100, 114, 97, 67, 110, 111, 115, 114, 101, 112, 31};

//: data
Byte mainCenterFormat[] = {69, 4, 8, 114, 32, 239, 64, 3, 97, 116, 97, 100, 47};

//: register_avtivity_account
Byte m_regnantUrl[] = {25, 25, 9, 133, 105, 85, 123, 31, 22, 116, 110, 117, 111, 99, 99, 97, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 114, 101, 116, 115, 105, 103, 101, 114, 211};

//: type
Byte appMedalTextIdent[] = {49, 4, 3, 101, 112, 121, 116, 53};

//: #ECECEC
Byte mainPlaceFishingColorFormat[] = {41, 7, 9, 49, 228, 113, 130, 204, 92, 67, 69, 67, 69, 67, 69, 35, 152};

//: black_list_activity_remove_black_failed
Byte kTerriblyId[] = {41, 39, 3, 100, 101, 108, 105, 97, 102, 95, 107, 99, 97, 108, 98, 95, 101, 118, 111, 109, 101, 114, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 115, 105, 108, 95, 107, 99, 97, 108, 98, 215};

//: ic_card_report
Byte appNameAttendancePath[] = {57, 14, 11, 225, 198, 239, 148, 192, 139, 78, 198, 116, 114, 111, 112, 101, 114, 95, 100, 114, 97, 99, 95, 99, 105, 95};

//: icon_me_arrow
Byte noti_cabinData[] = {48, 13, 9, 180, 50, 23, 56, 30, 229, 119, 111, 114, 114, 97, 95, 101, 109, 95, 110, 111, 99, 105, 203};

//: head_default
Byte mainValueStr[] = {97, 12, 10, 247, 61, 23, 94, 102, 113, 165, 116, 108, 117, 97, 102, 101, 100, 95, 100, 97, 101, 104, 133};

//: contact_tag_fragment_sure
Byte dream_showMarkIdent[] = {48, 25, 10, 227, 36, 199, 75, 100, 78, 170, 101, 114, 117, 115, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 62};

//: personcart_profile_bg
Byte main_showStr[] = {32, 21, 8, 46, 27, 193, 220, 117, 103, 98, 95, 101, 108, 105, 102, 111, 114, 112, 95, 116, 114, 97, 99, 110, 111, 115, 114, 101, 112, 176};

//: #FDF4C9
Byte mMediaIdent[] = {59, 7, 9, 204, 48, 233, 120, 74, 13, 57, 67, 52, 70, 68, 70, 35, 23};

//: group_info_activity_op_failed
Byte userCropId[] = {57, 29, 9, 42, 234, 209, 220, 71, 86, 100, 101, 108, 105, 97, 102, 95, 112, 111, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 129};

//: user_id
Byte mainKeyMessage[] = {33, 7, 11, 17, 115, 35, 223, 119, 108, 108, 147, 100, 105, 95, 114, 101, 115, 117, 67};

//: please_contact_your_administrator
Byte mainPlaceStr[] = {51, 33, 5, 5, 44, 114, 111, 116, 97, 114, 116, 115, 105, 110, 105, 109, 100, 97, 95, 114, 117, 111, 121, 95, 116, 99, 97, 116, 110, 111, 99, 95, 101, 115, 97, 101, 108, 112, 137};

//: isfrend
Byte app_toText[] = {43, 7, 11, 62, 82, 178, 7, 31, 170, 188, 96, 100, 110, 101, 114, 102, 115, 105, 66};

//: 未设置
Byte kTeamValue[] = {40, 9, 9, 140, 146, 151, 76, 186, 159, 174, 189, 231, 190, 174, 232, 170, 156, 230, 6};

//: ic_card_edit
Byte dreamEraseFormat[] = {67, 12, 12, 231, 88, 91, 157, 234, 27, 173, 12, 216, 116, 105, 100, 101, 95, 100, 114, 97, 99, 95, 99, 105, 36};

//: /other/feedback
Byte showOffName[] = {72, 15, 13, 238, 207, 22, 78, 113, 57, 242, 115, 223, 165, 107, 99, 97, 98, 100, 101, 101, 102, 47, 114, 101, 104, 116, 111, 47, 39};

//: code
Byte showDateStr[] = {85, 4, 9, 33, 185, 138, 29, 227, 54, 101, 100, 111, 99, 196};

//: black_list_activity_remove_black
Byte kSeparationMsg[] = {23, 32, 12, 165, 30, 151, 183, 246, 205, 227, 82, 234, 107, 99, 97, 108, 98, 95, 101, 118, 111, 109, 101, 114, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 115, 105, 108, 95, 107, 99, 97, 108, 98, 112};

//: team_create_helper_create_failed
Byte kShowerName[] = {94, 32, 7, 142, 201, 143, 101, 100, 101, 108, 105, 97, 102, 95, 101, 116, 97, 101, 114, 99, 95, 114, 101, 112, 108, 101, 104, 95, 101, 116, 97, 101, 114, 99, 95, 109, 97, 101, 116, 197};

//: add_friend_add_fail
Byte dreamStatusStr[] = {95, 19, 3, 108, 105, 97, 102, 95, 100, 100, 97, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 220};

//: contact_tag_fragment_cancel
Byte userRepairIdent[] = {36, 27, 3, 108, 101, 99, 110, 97, 99, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 227};

//: gotoBlacklist
Byte dreamPictureData[] = {72, 13, 12, 201, 79, 24, 39, 19, 216, 214, 225, 37, 116, 115, 105, 108, 107, 99, 97, 108, 66, 111, 116, 111, 103, 101};

//: report_activity_title
Byte notiTeamKey[] = {21, 21, 5, 10, 227, 101, 108, 116, 105, 116, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 114, 111, 112, 101, 114, 67};

//: back_arrow_bl
Byte noti_patienceFormat[] = {11, 13, 9, 148, 5, 67, 226, 239, 186, 108, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 103};

//: his_qr
Byte k_containerMsg[] = {88, 6, 8, 153, 239, 96, 239, 106, 114, 113, 95, 115, 105, 104, 200};

//: add_friend_request_fail
Byte main_quickId[] = {25, 23, 8, 63, 47, 33, 154, 22, 108, 105, 97, 102, 95, 116, 115, 101, 117, 113, 101, 114, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 166};

//: #8A8E98
Byte appSeparationIdent[] = {94, 7, 9, 177, 100, 252, 107, 190, 101, 56, 57, 69, 56, 65, 56, 35, 18};

//: name
Byte showMessageFormat[] = {4, 4, 6, 86, 93, 186, 101, 109, 97, 110, 7};

//: group_id
Byte show_freedChangeData[] = {75, 8, 7, 203, 171, 111, 10, 100, 105, 95, 112, 117, 111, 114, 103, 162};

//: user_profile_avtivity_remove_friend_tip
Byte notiCabinId[] = {63, 39, 11, 193, 53, 163, 79, 223, 4, 47, 224, 112, 105, 116, 95, 100, 110, 101, 105, 114, 102, 95, 101, 118, 111, 109, 101, 114, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 101, 108, 105, 102, 111, 114, 112, 95, 114, 101, 115, 117, 215};

//: request_successful
Byte k_shootMinUrl[] = {90, 18, 4, 55, 108, 117, 102, 115, 115, 101, 99, 99, 117, 115, 95, 116, 115, 101, 117, 113, 101, 114, 23};

//: user_profile_avtivity_remove_friend
Byte main_viewFormat[] = {4, 35, 13, 182, 182, 137, 194, 136, 244, 195, 24, 24, 83, 100, 110, 101, 105, 114, 102, 95, 101, 118, 111, 109, 101, 114, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 101, 108, 105, 102, 111, 114, 112, 95, 114, 101, 115, 117, 54};

//: contact_tag_fragment_add_success
Byte dream_scramMaxValue[] = {1, 32, 3, 115, 115, 101, 99, 99, 117, 115, 95, 100, 100, 97, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 128};

//: group_chat_avatar_activity_add_black_success
Byte show_valueFishingContainerMessage[] = {3, 44, 5, 95, 66, 115, 115, 101, 99, 99, 117, 115, 95, 107, 99, 97, 108, 98, 95, 100, 100, 97, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 114, 97, 116, 97, 118, 97, 95, 116, 97, 104, 99, 95, 112, 117, 111, 114, 103, 101};

//: #FF483D
Byte kSkyTitle[] = {72, 7, 9, 114, 211, 155, 117, 45, 232, 68, 51, 56, 52, 70, 70, 35, 10};

//: /user/detail
Byte appRepairMessage[] = {32, 12, 5, 177, 219, 108, 105, 97, 116, 101, 100, 47, 114, 101, 115, 117, 47, 129};

//: contact_tag_fragment_delete_success
Byte main_allName[] = {54, 35, 5, 167, 37, 115, 115, 101, 99, 99, 117, 115, 95, 101, 116, 101, 108, 101, 100, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 211};

//: account
Byte show_toStr[] = {24, 7, 7, 225, 53, 63, 116, 116, 110, 117, 111, 99, 99, 97, 193};

//: #F6F7FA
Byte dreamEnableValue[] = {35, 7, 11, 19, 132, 99, 200, 138, 104, 129, 167, 65, 70, 55, 70, 54, 70, 35, 235};

//: message_remark_name
Byte mKeyWorkplaceName[] = {82, 19, 8, 155, 48, 194, 249, 190, 101, 109, 97, 110, 95, 107, 114, 97, 109, 101, 114, 95, 101, 103, 97, 115, 115, 101, 109, 228};

//: ic_card_black
Byte show_pictureKey[] = {74, 13, 5, 240, 90, 107, 99, 97, 108, 98, 95, 100, 114, 97, 99, 95, 99, 105, 81};

//: avatar
Byte notiCurValue[] = {2, 6, 6, 144, 158, 159, 114, 97, 116, 97, 118, 97, 247};

//: ic_sex_woman
Byte user_manUrl[] = {26, 12, 7, 32, 136, 192, 4, 110, 97, 109, 111, 119, 95, 120, 101, 115, 95, 99, 105, 152};

//: black_list_activity_add_black_failed
Byte showWorkplaceKey[] = {48, 36, 5, 79, 70, 100, 101, 108, 105, 97, 102, 95, 107, 99, 97, 108, 98, 95, 100, 100, 97, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 115, 105, 108, 95, 107, 99, 97, 108, 98, 1};

//: message_info_activity_message_info
Byte kBubbleData[] = {74, 34, 3, 111, 102, 110, 105, 95, 101, 103, 97, 115, 115, 101, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 101, 103, 97, 115, 115, 101, 109, 153};

//: jpg
Byte k_regulationFormat[] = {45, 3, 8, 96, 176, 14, 210, 75, 103, 112, 106, 57};

//: add_friend_activity_add_friend
Byte showItemRegulationValue[] = {92, 30, 5, 105, 87, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 22};

//: /group/getgroups
Byte showCloudFormat[] = {23, 16, 11, 146, 200, 48, 38, 72, 131, 108, 249, 115, 112, 117, 111, 114, 103, 116, 101, 103, 47, 112, 117, 111, 114, 103, 47, 173};

//: /group/addgroupuser
Byte userAddIdent[] = {64, 19, 7, 172, 220, 122, 33, 114, 101, 115, 117, 112, 117, 111, 114, 103, 100, 100, 97, 47, 112, 117, 111, 114, 103, 47, 103};

//: mobile
Byte appWorkplaceContent[] = {92, 6, 4, 144, 101, 108, 105, 98, 111, 109, 116};
...
@implementation ApproximateViewController
...
//    [self setUpNav];
    ...
    self.view.backgroundColor = [UIColor min:StringFromConventData(dreamEnableValue)];
    ...
    dict[StringFromConventData(mainKeyMessage)] = self.userId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [CoverPageMode bubbleFailed:[NSString stringWithFormat:StringFromConventData(appRepairMessage)] reload_strong:dict with:NO forward:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict record:StringFromConventData(showDateStr)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict successAdd:StringFromConventData(mainCenterFormat)];
            //: self.userAcount = [data newStringValueForKey:@"account"];
            self.userAcount = [data record:StringFromConventData(show_toStr)];
         ...
         autoreleasepool{} __weak __typeof__(self) __weak_self__ = self;
            ...
            [[NIMSDK sharedSDK].userManager fetchUserInfos:@[self.userId] completion:^(NSArray<NIMUser *> * _Nullable users, NSError * _Nullable error) {
                ...
                if (users.count) {
                    ...
                    [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromConventData(mainValueStr)]];
                    ...
                    if (self.user.userInfo.gender == NIMUserGenderMale) {
                        ...
                        _sexImg.image = [UIImage imageNamed:StringFromConventData(userSeparationTableViewValue)];
                    //: }else if (self.user.userInfo.gender == NIMUserGenderFemale){
                    }else if (self.user.userInfo.gender == NIMUserGenderFemale){
                        //: _sexImg.image = [UIImage imageNamed:@"ic_sex_woman"];
                        _sexImg.image = [UIImage imageNamed:StringFromConventData(user_manUrl)];
                    }
...
//    [SVProgressHUD show];
    ...
    [CoverPageMode bubbleFailed:[NSString stringWithFormat:StringFromConventData(showCloudFormat)] reload_strong:nil with:NO forward:^(id responseObject) {
...
//        [SVProgressHUD dismissWithCompletion:^{
            ...
            if (code.integerValue == 0) {
                ...
                NSArray *dataArray = [resultDict viewKey:StringFromConventData(mainCenterFormat)];
                //: NSDictionary *dataDict = [NSDictionary dictionaryWithObject:dataArray forKey:@"item_data"];
                NSDictionary *dataDict = [NSDictionary dictionaryWithObject:dataArray forKey:StringFromConventData(noti_viewGrandpaMsg)];
                //: HMDataPicker *dataPick = [[HMDataPicker alloc] initWithDelegate:self dataDict:dataDict selectedDict:nil jsonNode:@"name"];
                CellValueView *dataPick = [[CellValueView alloc] initWithCard:self dismiss_strong:dataDict detect:nil field:StringFromConventData(showMessageFormat)];
                //: dataPick.tag = 500;
                dataPick.tag = 500;
                //: [dataPick show];
                [dataPick referShow];
...
-(void)viewRange:(id)sender{
    ...
    if (switcher.on) {
        ...
        dict[StringFromConventData(appWorkplaceContent)] = self.userId;
        //: dict[@"type"] = @"1";
        dict[StringFromConventData(appMedalTextIdent)] = @"1";//拉入黑名单
        //: [wself refresh];
        [wself model];
    ...
    //: }else{
        ...
        dict[StringFromConventData(appWorkplaceContent)] = self.userId;
        //: dict[@"type"] = @"0";
        dict[StringFromConventData(appMedalTextIdent)] = @"0";//解除黑名单
        //: [wself refresh];
        [wself model];
...
- (void)inscriptionShould
{
    ...
    [self ting:^(NSArray *uids, NSString *name, UIImage *avater) {
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
                        ;
...
//        [SVProgressHUD show];
        ...
        [self demonstrate:avater titleImage:^(NSString *urlString) {
...
- (void)ting:(ContactSelectFinishBlock) block{
...
- (void)demonstrate:(UIImage *)image titleImage:(void(^)(NSString *urlString ))complete {
...
-(void)push{
    ...
    dict[StringFromConventData(show_freedChangeData)] = [_groupDict record:@"id"];
    //: dict[@"friend_ids"] = self.user.userId;
    dict[StringFromConventData(dreamHostaFormat)] = self.user.userId;
    //: dict[@"isfrend"] = isMyFriend?@"1":@"0";
    dict[StringFromConventData(app_toText)] = isMyFriend?@"1":@"0";

    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/group/addgroupuser"] params:dict isShow:YES success:^(id responseObject) {
    [CoverPageMode bubbleFailed:[NSString stringWithFormat:StringFromConventData(userAddIdent)] reload_strong:dict with:YES forward:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSLog(@"-----%@",resultDict);
    //: } failed:^(id responseObject, NSError *error) {
...
- (void)detailImage{
    ...
    [ self.changeRemarksView container: self.user];
    //: [self.changeRemarksView animationShow];
    [self.changeRemarksView priceTag];
}
...
//        _userView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"personCard_bg"]];
        ...
        Bg.image = [UIImage imageNamed:StringFromConventData(main_repairText)];
        ...
        UIImageView *userBg = [[UIImageView alloc]initWithFrame:CGRectMake(15, [UIDevice tingHeight]+44+20, [[UIScreen mainScreen] bounds].size.width-30, 140)];
        //: userBg.image = [UIImage imageNamed:@"personcart_profile_bg"];
        userBg.image = [UIImage imageNamed:StringFromConventData(main_showStr)];
        ...
        QrBtn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-30-36, [UIDevice tingHeight]+44+35, 36, 36);
//        QrBtn.backgroundColor = [UIColor whiteColor];
        //: [QrBtn setImage:[UIImage imageNamed:@"his_qr"] forState:UIControlStateNormal];
        [QrBtn setImage:[UIImage imageNamed:StringFromConventData(k_containerMsg)] forState:UIControlStateNormal];
        //: [QrBtn addTarget:self action:@selector(handleQrbtn) forControlEvents:UIControlEventTouchUpInside];
        [QrBtn addTarget:self action:@selector(coverFrame) forControlEvents:UIControlEventTouchUpInside];
        ...
        _accountView.backgroundColor = [UIColor min:StringFromConventData(mMediaIdent)];
...
//        self.accountId.backgroundColor = RGB_COLOR_String(@"#FDF4C9");
        ...
        self.accountId.textColor = [UIColor min:StringFromConventData(mChangePath)];
        ...
        if(isMyFriend){
            ...
            _messageBtn.frame = CGRectMake(15, userBg.bottom+10, width, 44);
            //: _messageBtn.backgroundColor = [UIColor colorWithHexString:@"#4B43DE"];
            _messageBtn.backgroundColor = [UIColor min:StringFromConventData(userCornerBarStateId)];
            ...
            _groupBtn.frame = CGRectMake(30+width, userBg.bottom+10, width, 44);
            //: _groupBtn.backgroundColor = [UIColor colorWithHexString:@"#4B43DE"];
            _groupBtn.backgroundColor = [UIColor min:StringFromConventData(userCornerBarStateId)];
        ...
        [self.closeBtn setImage:[UIImage imageNamed:StringFromConventData(noti_patienceFormat)] forState:(UIControlStateNormal)];
...
- (UIView *)personView
{
    ...
    if(!_personView){
        ...
        pic3.image = [UIImage imageNamed:StringFromConventData(notiMembershipKey)];
        ...
        [self.switchNotice addTarget:self action:@selector(sumervalAfter:) forControlEvents:UIControlEventValueChanged];
        //: self.switchNotice.onTintColor = [UIColor colorWithHexString:@"#4B43DE"];
        self.switchNotice.onTintColor = [UIColor min:StringFromConventData(userCornerBarStateId)];
        ...
        line3.backgroundColor = [UIColor min:StringFromConventData(mainPlaceFishingColorFormat)];
        ...
        pic4.image = [UIImage imageNamed:StringFromConventData(show_pictureKey)];
        ...
        [blackBtn addTarget:self action:@selector(restoreButton) forControlEvents:UIControlEventTouchUpInside];
        ...
        [self.switchBlack addTarget:self action:@selector(darked:) forControlEvents:UIControlEventValueChanged];
        //: self.switchBlack.onTintColor = [UIColor colorWithHexString:@"#4B43DE"];
        self.switchBlack.onTintColor = [UIColor min:StringFromConventData(userCornerBarStateId)];
...
//        [shareCartView addSubview:arrow5];
        ...
        UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(detailImage)];
        ...
        pic1.image = [UIImage imageNamed:StringFromConventData(dreamEraseFormat)];
        ...
        self.labRemark.textColor = [UIColor min:StringFromConventData(appSeparationIdent)];
        ...
        arrow.image = [UIImage imageNamed:StringFromConventData(noti_cabinData)];
        ...
        line1.backgroundColor = [UIColor min:StringFromConventData(mainPlaceFishingColorFormat)];
...
//        [signView addSubview:line2];
        ...
        UITapGestureRecognizer *reporttapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(bottomMid)];
        ...
        picreport.image = [UIImage imageNamed:StringFromConventData(appNameAttendancePath)];
        ...
        arrowreport.image = [UIImage imageNamed:StringFromConventData(noti_cabinData)];
        ...
        self.btnAdd.layer.borderColor = [UIColor min:StringFromConventData(user_mayTitle)].CGColor;
        ...
        self.btnDelete.layer.borderColor = [UIColor min:StringFromConventData(user_mayTitle)].CGColor;
...
- (KeyShowView *)reprotView
{
    ...
    if(!_reprotView){
        ...
        _reprotView = [[KeyShowView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
-(void)messagePressed:(NSString *)reason
{
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"contact"] = reason?:@"";
    dict[StringFromConventData(showContainerMsg)] = reason?:@"";
    //: [ZCHttpManager postWithUrl:[NSString stringWithFormat:@"/other/feedback"] params:dict isShow:NO success:^(id responseObject) {
    [CoverPageMode circle:[NSString stringWithFormat:StringFromConventData(showOffName)] godspeed:dict preserve:NO bottom:^(id responseObject) {
    //: } failed:^(id responseObject, NSError *error) {
...
Byte * ConventDataToCache(Byte *data) {
    int charter = data[0];
    int attendance = data[1];
    int crush = data[2];
    if (!charter) return data + crush;
    for (int i = 0; i < attendance / 2; i++) {
        int begin = crush + i;
        int end = crush + attendance - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[crush + attendance] = 0;
    return data + crush;
}

NSString *StringFromConventData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)ConventDataToCache(data)];
}  
