...
NSString *StringFromBorrowData(Byte *data);        


//: __SCOPED__
Byte show_lanceKey[] = {3, 10, 80, 8, 136, 118, 75, 125, 15, 15, 3, 243, 255, 0, 245, 244, 15, 15, 100};

//: ic_invisible
Byte mHorribleName[] = {22, 12, 7, 9, 219, 105, 10, 31, 191, 98, 92, 88, 98, 103, 111, 98, 108, 98, 91, 101, 94, 127};

//: #F6F6F6
Byte userTitleFormat[] = {50, 7, 39, 11, 140, 20, 63, 234, 75, 249, 31, 252, 31, 15, 31, 15, 31, 15, 192};

//: login_agreement_press
Byte appOpenUrl[] = {92, 21, 64, 5, 123, 44, 47, 39, 41, 46, 31, 33, 39, 50, 37, 37, 45, 37, 46, 52, 31, 48, 50, 37, 51, 51, 68};

//: activity_register_next
Byte user_hormoneName[] = {72, 22, 3, 13, 212, 230, 97, 2, 217, 243, 22, 4, 235, 94, 96, 113, 102, 115, 102, 113, 118, 92, 111, 98, 100, 102, 112, 113, 98, 111, 92, 107, 98, 117, 113, 134};

//: ic_visible
Byte dream_dominateText[] = {19, 10, 73, 13, 64, 109, 174, 73, 132, 107, 225, 70, 106, 32, 26, 22, 45, 32, 42, 32, 25, 35, 28, 240};

//: ppp
Byte notiMayMsg[] = {88, 3, 20, 5, 187, 92, 92, 92, 223};

//: activity_register_agree
Byte appEconomistPath[] = {39, 23, 94, 5, 59, 3, 5, 22, 11, 24, 11, 22, 27, 1, 20, 7, 9, 11, 21, 22, 7, 20, 1, 3, 9, 20, 7, 7, 118};

//: vpn
Byte showNecessaryUrl[] = {34, 3, 50, 13, 75, 67, 43, 152, 163, 18, 162, 199, 254, 68, 62, 60, 232};

//: tap
Byte showMessageGoryIdent[] = {80, 3, 4, 4, 112, 93, 108, 229};

//: login_agreement_normal
Byte noti_killerPath[] = {71, 22, 10, 6, 171, 69, 98, 101, 93, 95, 100, 85, 87, 93, 104, 91, 91, 99, 91, 100, 106, 85, 100, 101, 104, 99, 87, 98, 187};

//: register_account
Byte dreamDestinationName[] = {68, 16, 13, 8, 187, 238, 195, 108, 101, 88, 90, 92, 102, 103, 88, 101, 82, 84, 86, 86, 98, 104, 97, 103, 126};

//: Read_agree_agreement
Byte app_trainingFormat[] = {74, 20, 16, 9, 124, 8, 45, 129, 25, 66, 85, 81, 84, 79, 81, 87, 98, 85, 85, 79, 81, 87, 98, 85, 85, 93, 85, 94, 100, 161};

//: register_account_activity_account
Byte noti_manCircleUrl[] = {70, 33, 47, 12, 119, 175, 170, 4, 4, 130, 214, 162, 67, 54, 56, 58, 68, 69, 54, 67, 48, 50, 52, 52, 64, 70, 63, 69, 48, 50, 52, 69, 58, 71, 58, 69, 74, 48, 50, 52, 52, 64, 70, 63, 69, 176};

//: SELF MATCHES %@
Byte dreamRemindKey[] = {59, 15, 74, 8, 128, 60, 52, 38, 9, 251, 2, 252, 214, 3, 247, 10, 249, 254, 251, 9, 214, 219, 246, 13};

//: account
Byte noti_consultantContent[] = {95, 7, 82, 4, 15, 17, 17, 29, 35, 28, 34, 96};

//: #333333
Byte mRepresentativeTitle[] = {87, 7, 79, 12, 46, 54, 73, 150, 247, 112, 122, 135, 212, 228, 228, 228, 228, 228, 228, 31};

//: login_bg
Byte dreamDrinkId[] = {10, 8, 68, 13, 41, 151, 114, 226, 178, 69, 77, 17, 126, 40, 43, 35, 37, 42, 27, 30, 35, 229};

//: ^[A-Za-z0-9_]{6,12}$
Byte main_streakUrl[] = {36, 20, 66, 8, 146, 243, 137, 252, 28, 25, 255, 235, 24, 31, 235, 56, 238, 235, 247, 29, 27, 57, 244, 234, 239, 240, 59, 226, 197};

//: ic_close_b
Byte kLibUrl[] = {12, 10, 28, 8, 10, 215, 211, 26, 77, 71, 67, 71, 80, 83, 87, 73, 67, 70, 230};

//: pass_user
Byte app_grandpaData[] = {82, 9, 61, 12, 209, 100, 233, 228, 1, 114, 71, 78, 51, 36, 54, 54, 34, 56, 54, 40, 53, 94};

//: password
Byte user_developerCurUrl[] = {45, 8, 32, 6, 24, 31, 80, 65, 83, 83, 87, 79, 82, 68, 100};

//: client
Byte user_duringKey[] = {78, 6, 41, 14, 93, 80, 151, 103, 5, 198, 105, 57, 121, 195, 58, 67, 64, 60, 69, 75, 22};

//: user_tip
Byte show_addMessage[] = {44, 8, 36, 11, 45, 102, 124, 64, 233, 207, 208, 81, 79, 65, 78, 59, 80, 69, 76, 226};

//: login_icon_user
Byte appEvolveText[] = {48, 15, 33, 5, 196, 75, 78, 70, 72, 77, 62, 72, 66, 78, 77, 62, 84, 82, 68, 81, 238};

//: ^[A-Za-z0-9_]{6,18}$
Byte dream_constitutionalUrl[] = {48, 20, 82, 8, 165, 236, 13, 208, 12, 9, 239, 219, 8, 15, 219, 40, 222, 219, 231, 13, 11, 41, 228, 218, 223, 230, 43, 210, 205};

//: activity_comment_setting_ys
Byte k_deerText[] = {23, 27, 82, 7, 209, 96, 252, 15, 17, 34, 23, 36, 23, 34, 39, 13, 17, 29, 27, 27, 19, 28, 34, 13, 33, 19, 34, 34, 23, 28, 21, 13, 39, 33, 79};

//: #4B43DE
Byte noti_closeYaValue[] = {94, 7, 2, 7, 155, 67, 33, 33, 50, 64, 50, 49, 66, 67, 7};

//: iOS
Byte m_muscleTitle[] = {6, 3, 59, 11, 228, 25, 103, 163, 187, 182, 171, 46, 20, 24, 209};

//: login_logo
Byte notiStreakMsg[] = {20, 10, 24, 5, 186, 84, 87, 79, 81, 86, 71, 84, 87, 79, 87, 206};

//: #999999
Byte k_showNameStreakMessage[] = {48, 7, 31, 8, 36, 35, 105, 230, 4, 26, 26, 26, 26, 26, 26, 227};

//: pass_tip
Byte main_contributionValue[] = {25, 8, 14, 8, 185, 102, 249, 76, 98, 83, 101, 101, 81, 102, 91, 98, 186};

//: mobilecode
Byte mMayNetworkData[] = {82, 10, 35, 5, 80, 74, 76, 63, 70, 73, 66, 64, 76, 65, 66, 20};

//: invitecode
Byte show_patrolValue[] = {11, 10, 70, 9, 92, 9, 113, 132, 226, 35, 40, 48, 35, 46, 31, 29, 41, 30, 31, 151};

//: register_account_activity_psw
Byte kMessageMsg[] = {84, 29, 71, 7, 101, 22, 27, 43, 30, 32, 34, 44, 45, 30, 43, 24, 26, 28, 28, 40, 46, 39, 45, 24, 26, 28, 45, 34, 47, 34, 45, 50, 24, 41, 44, 48, 37};

//: tun
Byte appRestoreFatigueTitle[] = {35, 3, 49, 7, 150, 65, 63, 67, 68, 61, 104};

//: login_icon_pwd
Byte showHeavyValue[] = {74, 14, 29, 13, 150, 121, 244, 221, 132, 212, 213, 62, 80, 79, 82, 74, 76, 81, 66, 76, 70, 82, 81, 66, 83, 90, 71, 39};

//: activity_login_login
Byte dream_egretId[] = {23, 20, 52, 13, 128, 68, 191, 8, 185, 118, 199, 227, 129, 45, 47, 64, 53, 66, 53, 64, 69, 43, 56, 59, 51, 53, 58, 43, 56, 59, 51, 53, 58, 90};

// __DEBUG__
// __CLOSE_PRINT__
//
//  ShowBubbleViewController.m
//  NIM
//
...
- (void)viewDidLoad {
    ...
    bg.image = [UIImage imageNamed:StringFromBorrowData(dreamDrinkId)];
...
- (void)initMain
{
    ...
    [backButton setImage:[UIImage imageNamed:StringFromBorrowData(kLibUrl)] forState:(UIControlStateNormal)];
    //: [backButton addTarget:self action:@selector(goBack) forControlEvents:UIControlEventTouchUpInside];
    [backButton addTarget:self action:@selector(mutualCrop) forControlEvents:UIControlEventTouchUpInside];
    ...
    _logoImageView = [[UIImageView alloc] initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-120)/2, [UIDevice tingHeight]+50, 120, 120)];
    ...
    _logoImageView.image = [UIImage imageNamed:StringFromBorrowData(notiStreakMsg)];
    ...
    usernameView.backgroundColor = [UIColor min:StringFromBorrowData(userTitleFormat)];
    ...
    self.titleImg.image = [UIImage imageNamed:StringFromBorrowData(appEvolveText)];
...
//    _usernameTextField.delegate = self;
    ...
    psdView.backgroundColor = [UIColor min:StringFromBorrowData(userTitleFormat)];
    ...
    self.titleImg2.image = [UIImage imageNamed:StringFromBorrowData(showHeavyValue)];
...
//    self.passwordTextField.delegate = self;
    ...
    [self.secureButton setImage:[UIImage imageNamed:StringFromBorrowData(dream_dominateText)] forState:UIControlStateNormal];
    //: [self.secureButton setImage:[UIImage imageNamed:@"ic_invisible"] forState:UIControlStateSelected];
    [self.secureButton setImage:[UIImage imageNamed:StringFromBorrowData(mHorribleName)] forState:UIControlStateSelected];
//    self.secureButton.hidden = YES;
    ...
    _loginButton.backgroundColor = [UIColor min:StringFromBorrowData(noti_closeYaValue)];
...
//    _loginButton.layer.shadowRadius = 0;
    ...
    [_registerButton setTitleColor:[UIColor min:StringFromBorrowData(noti_closeYaValue)] forState:UIControlStateNormal];
    ...
    [_agreementButton setImage:[UIImage imageNamed:StringFromBorrowData(noti_killerPath)] forState:UIControlStateNormal];
    //: [_agreementButton setImage:[UIImage imageNamed:@"login_agreement_press"] forState:UIControlStateSelected];
    [_agreementButton setImage:[UIImage imageNamed:StringFromBorrowData(appOpenUrl)] forState:UIControlStateSelected];
...
- (void)oned:(UIButton *)sender
{
    ...
    if (sender.selected) { // 按下去了就是明文
        ...
        [sender setImage:[UIImage imageNamed:StringFromBorrowData(mHorribleName)] forState:UIControlStateNormal];
    ...
    //: } else { 
        ...
        [sender setImage:[UIImage imageNamed:StringFromBorrowData(dream_dominateText)] forState:UIControlStateNormal];
        //: [UIView animateWithDuration:0.25 animations:^{
        [UIView animateWithDuration:0.25 animations:^{
...
- (YYLabel *)protocolLabel {
    ...
    if (!_protocolLabel) {
        ...
        [text1 yy_setTextHighlightRange:NSMakeRange(0, originText.length)//设置点击的位置
                                  ...
                                  color:[UIColor min:StringFromBorrowData(noti_closeYaValue)]
...
- (BOOL)sessionAcross
{
    ...
    NSArray *keys = [dict[StringFromBorrowData(show_lanceKey)]allKeys];
    //: for (NSString *key in keys) {
    for (NSString *key in keys) {
        //: if ([key rangeOfString:@"tap"].location != NSNotFound ||
        if ([key rangeOfString:StringFromBorrowData(showMessageGoryIdent)].location != NSNotFound ||
            //: [key rangeOfString:@"tun"].location != NSNotFound ||
            [key rangeOfString:StringFromBorrowData(appRestoreFatigueTitle)].location != NSNotFound ||
            //: [key rangeOfString:@"ppp"].location != NSNotFound){
            [key rangeOfString:StringFromBorrowData(notiMayMsg)].location != NSNotFound){
            //: return YES;
            return YES;
        }
    }
...
- (BOOL)snapline:(NSString *)input {
    ...
    NSString *pattern = StringFromBorrowData(main_streakUrl);

    //: NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", pattern];
    NSPredicate *predicate = [NSPredicate predicateWithFormat:StringFromBorrowData(dreamRemindKey), pattern];
    //: return [predicate evaluateWithObject:input];
    return [predicate evaluateWithObject:input];
}
//: - (BOOL)isPSDValidString:(NSString *)input {
- (BOOL)phonation:(NSString *)input {
    //: NSString *pattern = @"^[A-Za-z0-9_]{6,18}$";
    NSString *pattern = StringFromBorrowData(dream_constitutionalUrl);
...
//    }
    ...
    [manager.registDict setObject:StringFromBorrowData(m_muscleTitle) forKey:StringFromBorrowData(user_duringKey)];
    //: [manager.registDict setObject:_usernameTextField.text forKey:@"account"];
    [manager.registDict setObject:_usernameTextField.text forKey:StringFromBorrowData(noti_consultantContent)];
    //: [manager.registDict setObject:_passwordTextField.text forKey:@"password"];
    [manager.registDict setObject:_passwordTextField.text forKey:StringFromBorrowData(user_developerCurUrl)];
    //: [manager.registDict setObject:@"" forKey:@"mobilecode"];
    [manager.registDict setObject:@"" forKey:StringFromBorrowData(mMayNetworkData)];
    //: [manager.registDict setObject:@"" forKey:@"invitecode"];
    [manager.registDict setObject:@"" forKey:StringFromBorrowData(show_patrolValue)];
    //: [manager.registDict setObject:[self isVPNConnected]?@"1":@"0" forKey:@"vpn"];
    [manager.registDict setObject:[self sessionAcross]?@"1":@"0" forKey:StringFromBorrowData(showNecessaryUrl)];
    ...
    [BarTo size:_usernameTextField.text ting:_passwordTextField.text session:^(BOOL sucess, NSString *msg) {
        @
        ...
        if (sucess) {
            ...
            MessageTitleViewController *vc = [[MessageTitleViewController alloc]init];
...
Byte * BorrowDataToCache(Byte *data) {
    int thanksAchieve = data[0];
    int skip = data[1];
    Byte bid = data[2];
    int conduct = data[3];
    if (!thanksAchieve) return data + conduct;
    for (int i = conduct; i < conduct + skip; i++) {
        int value = data[i] + bid;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
...
NSString *StringFromBorrowData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)BorrowDataToCache(data)];
}
