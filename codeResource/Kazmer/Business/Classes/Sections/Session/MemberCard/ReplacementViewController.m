...
NSString *StringFromEstablishmentData(Byte *data);


//: attach
Byte user_optName[] = {53, 6, 6, 81, 94, 147, 104, 99, 97, 116, 116, 97, 79};

//: 邀请你加入讨论组
Byte notiTitleMayKey[] = {36, 24, 5, 56, 48, 132, 187, 231, 186, 174, 232, 168, 174, 232, 165, 133, 229, 160, 138, 229, 160, 189, 228, 183, 175, 232, 128, 130, 233, 253};

//: data
Byte mainPowerOptMsg[] = {20, 4, 4, 176, 97, 116, 97, 100, 2};

//: kNIMTeamListDataTeamMembersChanged
Byte mainSkiTitle[] = {72, 34, 5, 74, 174, 100, 101, 103, 110, 97, 104, 67, 115, 114, 101, 98, 109, 101, 77, 109, 97, 101, 84, 97, 116, 97, 68, 116, 115, 105, 76, 109, 97, 101, 84, 77, 73, 78, 107, 25};

//: #4B43DE
Byte m_tapMessage[] = {94, 7, 7, 87, 131, 130, 79, 69, 68, 51, 52, 66, 52, 35, 130};

//: /team/getTeamSetting
Byte showAccentDuringKey[] = {50, 20, 5, 91, 215, 103, 110, 105, 116, 116, 101, 83, 109, 97, 101, 84, 116, 101, 103, 47, 109, 97, 101, 116, 47, 20};

//: 扩展消息
Byte noti_distinctiveStr[] = {40, 12, 13, 53, 190, 159, 150, 158, 21, 74, 157, 136, 242, 175, 129, 230, 136, 182, 230, 149, 177, 229, 169, 137, 230, 189};

//: postscript
Byte mainHoppingPath[] = {42, 10, 13, 50, 205, 135, 76, 136, 48, 121, 151, 121, 133, 116, 112, 105, 114, 99, 115, 116, 115, 111, 112, 208};

//: 邀请你加入高级群
Byte notiUntilKey[] = {88, 24, 5, 14, 247, 164, 190, 231, 167, 186, 231, 152, 171, 233, 165, 133, 229, 160, 138, 229, 160, 189, 228, 183, 175, 232, 128, 130, 233, 43};

//: code
Byte noti_itchIdent[] = {61, 4, 4, 219, 101, 100, 111, 99, 28};

//: group_member_info_activity_team_creator
Byte app_twistShowValueMsg[] = {71, 39, 8, 214, 108, 99, 3, 218, 114, 111, 116, 97, 101, 114, 99, 95, 109, 97, 101, 116, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 162};

//: back_arrow_bl
Byte main_muscleIdent[] = {82, 13, 7, 156, 119, 60, 10, 108, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 83};

//: modify_activity_modify_success
Byte dreamLibMessage[] = {41, 30, 12, 31, 95, 223, 253, 149, 81, 22, 40, 77, 115, 115, 101, 99, 99, 117, 115, 95, 121, 102, 105, 100, 111, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 121, 102, 105, 100, 111, 109, 234};

//: 邀请你加入超大群
Byte dream_porterHaveStr[] = {63, 24, 10, 182, 154, 17, 230, 120, 198, 106, 164, 190, 231, 167, 164, 229, 133, 182, 232, 165, 133, 229, 160, 138, 229, 160, 189, 228, 183, 175, 232, 128, 130, 233, 168};

//: canAddFriend
Byte user_deadlinePath[] = {19, 12, 6, 255, 205, 220, 100, 110, 101, 105, 114, 70, 100, 100, 65, 110, 97, 99, 157};

//: group_info_activity_op_failed
Byte dreamKeyText[] = {12, 29, 8, 86, 241, 23, 10, 40, 100, 101, 108, 105, 97, 102, 95, 112, 111, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 81};

//: group_info_activity_team_member
Byte dream_yaUrl[] = {35, 31, 8, 63, 233, 43, 95, 168, 114, 101, 98, 109, 101, 109, 95, 109, 97, 101, 116, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 51};

//: ic_group_addmember
Byte kCrushNetworkData[] = {41, 18, 12, 134, 232, 95, 77, 191, 39, 98, 202, 55, 114, 101, 98, 109, 101, 109, 100, 100, 97, 95, 112, 117, 111, 114, 103, 95, 99, 105, 12};
...
@interface ReplacementViewController ()<UITableViewDataSource,UITableViewDelegate,DelegateZone,SpecsDelegate>
...
- (instancetype)initWithRecord:(MetadataManager *)dataSource {
    ...
    if (self) {
        ...
        NSString *kNIMTeamListDataTeamMembersChanged = StringFromEstablishmentData(mainSkiTitle);
...
- (void)viewDidLoad {
    ...
    [CoverPageMode bubbleFailed:[NSString stringWithFormat:StringFromEstablishmentData(showAccentDuringKey)] reload_strong:dict with:NO forward:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict record:StringFromEstablishmentData(noti_itchIdent)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict successAdd:StringFromEstablishmentData(mainPowerOptMsg)];
...
- (void)byUi {
    ...
    [backButton setImage:[UIImage imageNamed:StringFromEstablishmentData(main_muscleIdent)] forState:(UIControlStateNormal)];
    ...
    labtitle.text = [PaintedNaturalLanguageTo exhibit:StringFromEstablishmentData(dream_yaUrl)];
    ...
    submitButton.backgroundColor = [UIColor min:StringFromEstablishmentData(m_tapMessage)];
    //: submitButton.layer.cornerRadius = 16;
    submitButton.layer.cornerRadius = 16;
    //: [submitButton setImage:[UIImage imageNamed:@"ic_group_addmember"] forState:(UIControlStateNormal)];
    [submitButton setImage:[UIImage imageNamed:StringFromEstablishmentData(kCrushNetworkData)] forState:(UIControlStateNormal)];
    ...
    //: } else {
        ...
        [[NIMSDK sharedSDK].teamManager updateMuteState:ismute
            ...
            if (!error) {
                ...
                msg = [PaintedNaturalLanguageTo exhibit:StringFromEstablishmentData(dreamLibMessage)];
            //: }else{
            }else{
                //: msg = [FFFLanguageManager getTextWithKey:@"group_info_activity_op_failed"];
                msg = [PaintedNaturalLanguageTo exhibit:StringFromEstablishmentData(dreamKeyText)];
            }
...
- (void)willed:(NSString *)uid
{
    ...
    [self.teamListManager magnitudeerval:@[uid] completion:^(NSError * _Nonnull error, NSString * _Nonnull msg) {
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TextEnableViewCell *cell = [TextEnableViewCell read:tableView];
    //: cell.delegate = self;
    cell.delegate = self;
    ...
    TingMessage *usrInfo = [[ButtonKit sheerOption] past:uId skinColour_strong:nil];
    ...
    cell.subtitleLabel.text = [PaintedNaturalLanguageTo exhibit:StringFromEstablishmentData(app_twistShowValueMsg)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *canMemberInfo = [_teamSettingConfig record:StringFromEstablishmentData(user_deadlinePath)];
...
- (void)messaged:(NSArray *)selectedContacts{
    ...
    [self beyondItem:selectedContacts upTing:nil];
}

//: - (void)didInviteUsers:(NSArray<NSString *> *)userIds
- (void)beyondItem:(NSArray<NSString *> *)userIds
            //: completion:(dispatch_block_t)completion {
            upTing:(dispatch_block_t)completion {
    ...
    NSMutableDictionary *info = [NSMutableDictionary dictionary];
    //: info[@"attach"] = @"扩展消息";
    info[StringFromEstablishmentData(user_optName)] = StringFromEstablishmentData(noti_distinctiveStr);
    //: switch (self.teamListManager.team.type) {
    switch (self.teamListManager.team.type) {
        //: case NIMTeamTypeNormal:
        case NIMTeamTypeNormal:
            //: info[@"postscript"] = @"邀请你加入讨论组".nim_localized;
            info[StringFromEstablishmentData(mainHoppingPath)] = StringFromEstablishmentData(notiTitleMayKey).messageWith;
            //: break;
            break;
        //: case NIMTeamTypeAdvanced:
        case NIMTeamTypeAdvanced:
            //: info[@"postscript"] = @"邀请你加入高级群".nim_localized;
            info[StringFromEstablishmentData(mainHoppingPath)] = StringFromEstablishmentData(notiUntilKey).messageWith;
            //: break;
            break;
        //: case NIMTeamTypeSuper:
        case NIMTeamTypeSuper:
            //: info[@"postscript"] = @"邀请你加入超大群".nim_localized;
            info[StringFromEstablishmentData(mainHoppingPath)] = StringFromEstablishmentData(dream_porterHaveStr).messageWith;
            //: break;
            break;
        //: default:
        default:
...
Byte * EstablishmentDataToCache(Byte *data) {
    int tube = data[0];
    int eraseConvince = data[1];
    int nameBarre = data[2];
    if (!tube) return data + nameBarre;
    for (int i = 0; i < eraseConvince / 2; i++) {
        int begin = nameBarre + i;
        int end = nameBarre + eraseConvince - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[nameBarre + eraseConvince] = 0;
    return data + nameBarre;
}

NSString *StringFromEstablishmentData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)EstablishmentDataToCache(data)];
}  
