...
typedef struct {
    Byte journalistSquad;
    Byte *sexuallyToll;
    unsigned int valueThinkArchitect;
} StructCalledGreatlyData;

@interface CalledGreatlyData : NSObject

+ (instancetype)sharedInstance;

//: ic_pic_share
@property (nonatomic, copy) NSString *kText_violationBarName;

//: contact_tag_fragment_cancel
@property (nonatomic, copy) NSString *kText_wortRelieveCosyData;

//: group_info_activity_update_failed
@property (nonatomic, copy) NSString *kText_houseString;

//: ic_close_w
@property (nonatomic, copy) NSString *kText_deployCollegeData;

//: tag_activity_set
@property (nonatomic, copy) NSString *kTitleEquivalentData;

//: group_info_activity_update_success
@property (nonatomic, copy) NSString *kTitle_dateProperHoppingName;

//: setting_privacy
@property (nonatomic, copy) NSString *kNameMysteryRecommendString;

//: warm_prompt
@property (nonatomic, copy) NSString *kTitleCastData;

//: ic_pic_save
@property (nonatomic, copy) NSString *kTitle_labContent;

@end

@implementation CalledGreatlyData

+ (instancetype)sharedInstance {
    static CalledGreatlyData *instance = nil;
...
+ (NSData *)CalledGreatlyDataToData:(NSArray<NSString *> *)value {
...
- (Byte *)CalledGreatlyDataToByte:(StructCalledGreatlyData *)data {
    for (int i = 0; i < data->valueThinkArchitect; i++) {
        data->sexuallyToll[i] ^= data->journalistSquad;
    }
    data->sexuallyToll[data->valueThinkArchitect] = 0;
    return data->sexuallyToll;
}

- (NSString *)StringFromCalledGreatlyData:(StructCalledGreatlyData *)data {
    return [NSString stringWithUTF8String:(char *)[self CalledGreatlyDataToByte:data]];
}

//: group_info_activity_update_success
- (NSString *)kTitle_dateProperHoppingName {
    if (!_kTitle_dateProperHoppingName) {
		NSArray<NSString *> *origin = @[@"214", @"195", @"222", @"196", @"193", @"238", @"216", @"223", @"215", @"222", @"238", @"208", @"210", @"197", @"216", @"199", @"216", @"197", @"200", @"238", @"196", @"193", @"213", @"208", @"197", @"212", @"238", @"194", @"196", @"210", @"210", @"212", @"194", @"194", @"62"];
		NSData *data = [CalledGreatlyData CalledGreatlyDataToData:origin];
        StructCalledGreatlyData value = (StructCalledGreatlyData){177, (Byte *)data.bytes, 34};
        _kTitle_dateProperHoppingName = [self StringFromCalledGreatlyData:&value];
    }
    return _kTitle_dateProperHoppingName;
}

//: tag_activity_set
- (NSString *)kTitleEquivalentData {
    if (!_kTitleEquivalentData) {
		NSArray<NSString *> *origin = @[@"5", @"16", @"22", @"46", @"16", @"18", @"5", @"24", @"7", @"24", @"5", @"8", @"46", @"2", @"20", @"5", @"184"];
		NSData *data = [CalledGreatlyData CalledGreatlyDataToData:origin];
        StructCalledGreatlyData value = (StructCalledGreatlyData){113, (Byte *)data.bytes, 16};
        _kTitleEquivalentData = [self StringFromCalledGreatlyData:&value];
    }
    return _kTitleEquivalentData;
}

//: ic_pic_save
- (NSString *)kTitle_labContent {
    if (!_kTitle_labContent) {
		NSArray<NSString *> *origin = @[@"152", @"146", @"174", @"129", @"152", @"146", @"174", @"130", @"144", @"135", @"148", @"228"];
		NSData *data = [CalledGreatlyData CalledGreatlyDataToData:origin];
        StructCalledGreatlyData value = (StructCalledGreatlyData){241, (Byte *)data.bytes, 11};
        _kTitle_labContent = [self StringFromCalledGreatlyData:&value];
    }
    return _kTitle_labContent;
}

//: contact_tag_fragment_cancel
- (NSString *)kText_wortRelieveCosyData {
    if (!_kText_wortRelieveCosyData) {
		NSArray<NSString *> *origin = @[@"59", @"55", @"54", @"44", @"57", @"59", @"44", @"7", @"44", @"57", @"63", @"7", @"62", @"42", @"57", @"63", @"53", @"61", @"54", @"44", @"7", @"59", @"57", @"54", @"59", @"61", @"52", @"199"];
		NSData *data = [CalledGreatlyData CalledGreatlyDataToData:origin];
        StructCalledGreatlyData value = (StructCalledGreatlyData){88, (Byte *)data.bytes, 27};
        _kText_wortRelieveCosyData = [self StringFromCalledGreatlyData:&value];
    }
    return _kText_wortRelieveCosyData;
}

//: group_info_activity_update_failed
- (NSString *)kText_houseString {
    if (!_kText_houseString) {
		NSArray<NSString *> *origin = @[@"233", @"252", @"225", @"251", @"254", @"209", @"231", @"224", @"232", @"225", @"209", @"239", @"237", @"250", @"231", @"248", @"231", @"250", @"247", @"209", @"251", @"254", @"234", @"239", @"250", @"235", @"209", @"232", @"239", @"231", @"226", @"235", @"234", @"197"];
		NSData *data = [CalledGreatlyData CalledGreatlyDataToData:origin];
        StructCalledGreatlyData value = (StructCalledGreatlyData){142, (Byte *)data.bytes, 33};
        _kText_houseString = [self StringFromCalledGreatlyData:&value];
    }
    return _kText_houseString;
}

//: ic_close_w
- (NSString *)kText_deployCollegeData {
    if (!_kText_deployCollegeData) {
		NSArray<NSString *> *origin = @[@"30", @"20", @"40", @"20", @"27", @"24", @"4", @"18", @"40", @"0", @"14"];
		NSData *data = [CalledGreatlyData CalledGreatlyDataToData:origin];
        StructCalledGreatlyData value = (StructCalledGreatlyData){119, (Byte *)data.bytes, 10};
        _kText_deployCollegeData = [self StringFromCalledGreatlyData:&value];
    }
    return _kText_deployCollegeData;
}

//: setting_privacy
- (NSString *)kNameMysteryRecommendString {
    if (!_kNameMysteryRecommendString) {
		NSArray<NSString *> *origin = @[@"8", @"30", @"15", @"15", @"18", @"21", @"28", @"36", @"11", @"9", @"18", @"13", @"26", @"24", @"2", @"168"];
		NSData *data = [CalledGreatlyData CalledGreatlyDataToData:origin];
        StructCalledGreatlyData value = (StructCalledGreatlyData){123, (Byte *)data.bytes, 15};
        _kNameMysteryRecommendString = [self StringFromCalledGreatlyData:&value];
    }
    return _kNameMysteryRecommendString;
}

//: ic_pic_share
- (NSString *)kText_violationBarName {
    if (!_kText_violationBarName) {
		NSArray<NSString *> *origin = @[@"26", @"16", @"44", @"3", @"26", @"16", @"44", @"0", @"27", @"18", @"1", @"22", @"97"];
		NSData *data = [CalledGreatlyData CalledGreatlyDataToData:origin];
        StructCalledGreatlyData value = (StructCalledGreatlyData){115, (Byte *)data.bytes, 12};
        _kText_violationBarName = [self StringFromCalledGreatlyData:&value];
    }
    return _kText_violationBarName;
}

//: warm_prompt
- (NSString *)kTitleCastData {
    if (!_kTitleCastData) {
		NSArray<NSString *> *origin = @[@"65", @"87", @"68", @"91", @"105", @"70", @"68", @"89", @"91", @"70", @"66", @"12"];
		NSData *data = [CalledGreatlyData CalledGreatlyDataToData:origin];
        StructCalledGreatlyData value = (StructCalledGreatlyData){54, (Byte *)data.bytes, 11};
        _kTitleCastData = [self StringFromCalledGreatlyData:&value];
    }
    return _kTitleCastData;
}
...
#import "PageUserLayer.h"
//: #import "TKImageView.h"
#import "PullResultView.h"
...
@interface TextMaxViewController ()
...
@property (nonatomic, strong) PullResultView *tkImageView;
//
...
@implementation TextMaxViewController
...
//    _hud = [DetectView showNoticeTo:self.view animated:YES];
...
- (void)viewDidLoad {
    ...
    [backButton setImage:[UIImage imageNamed:[CalledGreatlyData sharedInstance].kText_deployCollegeData] forState:(UIControlStateNormal)];
    ...
    _btnIn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-15-24, [UIDevice comeDownSuperphylum]+10, 24, 24);
    //: [_btnIn setImage:[UIImage imageNamed:@"ic_pic_share"] forState:UIControlStateNormal];
    [_btnIn setImage:[UIImage imageNamed:[CalledGreatlyData sharedInstance].kText_violationBarName] forState:UIControlStateNormal];
    //: [_btnIn addTarget:self action:@selector(onTouchshare) forControlEvents:UIControlEventTouchUpInside];
    [_btnIn addTarget:self action:@selector(datePull) forControlEvents:UIControlEventTouchUpInside];
    ...
    [_btnSave setImage:[UIImage imageNamed:[CalledGreatlyData sharedInstance].kTitle_labContent] forState:UIControlStateNormal];
...
//    [self.view addSubview:self.scrollView];
    ...
    _ImageView.frame = CGRectMake(0, (44.0f + [UIDevice comeDownSuperphylum]), [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice comeDownSuperphylum]));
...
- (void)setShowView:(UIImage *)picImg{
...
- (void)client{
    ...
    UIImage *yyImage = [self utilizer:self.imagePath];
    //: self.isCut = YES;
    self.isCut = YES;
...
//    LengthCropViewController *controller = [[LengthCropViewController alloc] initWithImage:yyImage];
...
- (void)workingPapers:(UIImage *)photo {
    ...
    _cropimage = [[UIImageView alloc] initWithFrame:CGRectMake(0, (44.0f + [UIDevice comeDownSuperphylum]), [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-(({ BOOL isPhoneX = NO; if (@available(iOS 11.0, *)) { isPhoneX = [[UIApplication sharedApplication] delegate].window.safeAreaInsets.bottom > 0.0; } isPhoneX;}) ? 49 + 35 : 49)-(44.0f + [UIDevice comeDownSuperphylum]))];
...
//    _cropView.layer.cornerRadius = diameter / 2; // 设置为圆形
    ...
    UIPanGestureRecognizer *panGesture = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(misconducted:)];
    //: [_cropView addGestureRecognizer:panGesture];
    [_cropView addGestureRecognizer:panGesture];


//    self.cropView.layer.sublayers = nil;
//    PageUserLayer * layer = [[PageUserLayer alloc] init];
//
...
- (void)misconducted:(UIPanGestureRecognizer *)gesture {
...
- (void)holderSupport {
    ...
    UIImageWriteToSavedPhotosAlbum(croppedImage, self, @selector(option:labelTable:date:), NULL);

}


//- (void)LengthCropViewController:(LengthCropViewController *)controller didFinishCroppingImage:(UIImage *)croppedImage{
//
//   self.ImageView.image = croppedImage;
//   [[self navigationController] popViewControllerAnimated:NO];
//}
//- (void)ImageCropViewControllerDidCancel:(LengthCropViewController *)controller{
...
//                                             self.scrollView.height - insets.top - insets.bottom);
    ...
    else
    {
        ...
        [[NIMSDK sharedSDK].resourceManager download:self.imageURL filepath:self.imagePath progress:nil completion:^(NSError * _Nullable error) {
            ...
            [weakSelf elite:weakSelf.imagePath];
        //: }];
        }];
    }
...
- (void)elite:(NSString *)path
{
    //: UIImage *yyImage = [self imageWithPath:path];
    UIImage *yyImage = [self utilizer:path];
...
- (UIImage *)utilizer:(NSString *)path
{
...
- (PullResultView *)tkImageView
{
    ...
    if(!_tkImageView){
        ...
        _tkImageView = [[PullResultView alloc]initWithFrame:CGRectMake(0, (44.0f + [UIDevice comeDownSuperphylum]), [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice comeDownSuperphylum])-(({ BOOL isPhoneX = NO; if (@available(iOS 11.0, *)) { isPhoneX = [[UIApplication sharedApplication] delegate].window.safeAreaInsets.bottom > 0.0; } isPhoneX;}) ? 49 + 35 : 49))];
    }
    //: return _tkImageView;
    return _tkImageView;
}
