...
@interface NoticeSessionConfig ()

//: @property (nonatomic,strong) NTESThreadDataSourceProvider *provider;
@property (nonatomic,strong) MaxShowProvider *provider;
...
@implementation NoticeSessionConfig
...
- (instancetype)initWithMember:(NIMMessage *)message
{
    ...
    if (self)
    {
        ...
        _provider = [[MaxShowProvider alloc] init];
...
@implementation MaxShowProvider
...
- (void)image:(NIMMessage *)firstMessage downward:(NIMKitDataProvideHandler)handler
{
    ...
    BOOL enablePullCloudMessages = [[NameTing pin] bold];
