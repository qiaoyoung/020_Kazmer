...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [textField addTarget:self action:@selector(uncolouredWith:) forControlEvents:UIControlEventEditingChanged];
...
- (void)byTingInput {
    ...
    [self uncolouredWith:self.textField];
}
...
- (void)uncolouredWith:(UITextField *)textField {
