...
@implementation RowPathGlowingView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [textField addTarget:self action:@selector(byChange:) forControlEvents:UIControlEventEditingChanged];
...
- (void)byChange:(UITextField *)textField {
