...
extern __attribute__((visibility ("default"))) NSString *const userTeamData;/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const noti_buttonUrl;/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const mFirstId;/** 即时聊天*/
