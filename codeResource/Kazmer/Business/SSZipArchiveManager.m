...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kDrawSortAdapter];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kDrawSortAdapter];
    ...
    NSString *path = [[MyUserKit sharedKit].emoticonBundle pathForResource:kDrawSortAdapter ofType:@".zip"];
    if (!path) {
