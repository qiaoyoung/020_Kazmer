 ...
 *
 * 如果您在使用 MaxEmpty 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
+ (__kindof NSURLSessionTask *)sumHire:(NSString *)URL
 ...
 */
//: + (__kindof NSURLSessionTask *)GET:(NSString *)URL
+ (__kindof NSURLSessionTask *)time:(NSString *)URL
                        //: parameters:(id)parameters
                        with:(id)parameters
...
+ (__kindof NSURLSessionTask *)click:(NSString *)URL
                         //: parameters:(id)parameters
                         parameters:(id)parameters
                            //: success:(YLHttpRequestSuccess)success
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)protrude:(NSString *)URL
                         //: parameters:(id)parameters
                         with:(id)parameters
                      //: responseCache:(YLHttpRequestCache)responseCache
...
+ (__kindof NSURLSessionTask *)maxFailure:(NSString *)URL
                                      //: parameters:(id)parameters
                                      shoot:(id)parameters
                                            //: name:(NSString *)name
                                            item:(NSString *)name
...
+ (__kindof NSURLSessionTask *)text:(NSString *)URL
                                       //: parameters:(id)parameters
                                       show:(id)parameters
                                             //: name:(NSString *)name
                                             query:(NSString *)name
                                             //: data:(NSData *)data
                                             standard:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         change:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        view_strong:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         ting:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          goop:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          shouldPress:(YLHttpRequestFailed)failure;
...
+ (__kindof NSURLSessionTask *)information:(NSString *)URL
                                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)background:(NSString *)URL
                                       //: fileDir:(NSString *)fileDir
                                       stride_strong:(NSString *)fileDir
                                      //: progress:(YLHttpProgress)progress
                                      need:(YLHttpProgress)progress
                                       //: success:(void(^)(NSString *filePath))success
                                       determineFailure:(void(^)(NSString *filePath))success
                                       //: failure:(YLHttpRequestFailed)failure;
...
+ (void)setValueText:(void(^)(AFHTTPSessionManager *sessionManager))sessionManager;
