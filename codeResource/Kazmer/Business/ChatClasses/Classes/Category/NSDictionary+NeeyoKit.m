...
@implementation NSDictionary (Mortification)

//: - (long long)nimkit_jsonLongLong: (NSString *)key
- (long long)executiveSession: (NSString *)key
{
...
- (NSArray *)barSinister: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (double)providerBy: (NSString *)key{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
    if ([object isKindOfClass:[NSString class]] ||
...
- (NSArray *)withArray: (NSString *)key
{
...
- (unsigned long long)json:(NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (NSDictionary *)pinion: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSInteger)lipogram: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (NSString *)underside: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]])
