...
//: @protocol WatchContactSelectConfig <NSObject>
@protocol FindRecent <NSObject>
 ...
 *  内置配置-选择好友
 */
//: @interface NIMContactFriendSelectConfig : NSObject<WatchContactSelectConfig>
@interface OldPin : NSObject<FindRecent>
 ...
 *  内置配置-选择群成员
 */
//: @interface NIMContactTeamMemberSelectConfig : NSObject<WatchContactSelectConfig>
@interface ProgressConfig : NSObject<FindRecent>
 ...
 *  内置配置-选择群
 */
//: @interface NIMContactTeamSelectConfig : NSObject<WatchContactSelectConfig>
@interface OptionSession : NSObject<FindRecent>
