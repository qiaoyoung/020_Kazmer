...
@property (nonatomic, copy) NSString *showBarreRepairMsg;

//: bounds
@property (nonatomic, copy) NSString *dream_tourValue;

//: 请在添加的某一项后面设置间距
@property (nonatomic, copy) NSString *show_sableKey;

//: keyboardWillChangeFrame
@property (nonatomic, copy) NSString *main_placeMessage;

//: bounds.size
@property (nonatomic, copy) NSString *mainConsensusUrl;

//: frame
@property (nonatomic, copy) NSString *dream_cabinIdent;

//: layoutSubviews
@property (nonatomic, copy) NSString *userAnnounceOptValue;

//: lee_alert_view_
@property (nonatomic, copy) NSString *appFashionMessage;

//: lee_alert_button_
@property (nonatomic, copy) NSString *mainRidgeSaladNameFormat;

//: path
@property (nonatomic, copy) NSString *main_emergencyId;
...
+ (instancetype)sharedInstance {
    static GrandparentData *instance = nil;
...
- (Byte *)GrandparentDataToCache:(Byte *)data {
    int worldView = data[0];
    int ureaTitle = data[1];
    for (int i = 0; i < worldView / 2; i++) {
        int begin = ureaTitle + i;
        int end = ureaTitle + worldView - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[ureaTitle + worldView] = 0;
    return data + ureaTitle;
}

- (NSString *)StringFromGrandparentData:(Byte *)data {
    return [NSString stringWithUTF8String:(char *)[self GrandparentDataToCache:data]];
}  

//: lee_alert_button_
- (NSString *)mainRidgeSaladNameFormat {
    if (!_mainRidgeSaladNameFormat) {
        Byte value[] = {17, 4, 23, 13, 95, 110, 111, 116, 116, 117, 98, 95, 116, 114, 101, 108, 97, 95, 101, 101, 108, 38};
        _mainRidgeSaladNameFormat = [self StringFromGrandparentData:value];
    }
    return _mainRidgeSaladNameFormat;
}

//: lee_alert_view_
- (NSString *)appFashionMessage {
    if (!_appFashionMessage) {
        Byte value[] = {15, 7, 203, 130, 136, 75, 172, 95, 119, 101, 105, 118, 95, 116, 114, 101, 108, 97, 95, 101, 101, 108, 86};
        _appFashionMessage = [self StringFromGrandparentData:value];
    }
    return _appFashionMessage;
}

//: frame
- (NSString *)dream_cabinIdent {
    if (!_dream_cabinIdent) {
        Byte value[] = {5, 3, 243, 101, 109, 97, 114, 102, 202};
        _dream_cabinIdent = [self StringFromGrandparentData:value];
    }
    return _dream_cabinIdent;
}

//: keyboardWillChangeFrame
- (NSString *)main_placeMessage {
    if (!_main_placeMessage) {
        Byte value[] = {23, 2, 101, 109, 97, 114, 70, 101, 103, 110, 97, 104, 67, 108, 108, 105, 87, 100, 114, 97, 111, 98, 121, 101, 107, 104};
        _main_placeMessage = [self StringFromGrandparentData:value];
    }
    return _main_placeMessage;
}

//: bounds
- (NSString *)dream_tourValue {
    if (!_dream_tourValue) {
        Byte value[] = {6, 10, 2, 27, 216, 197, 235, 251, 233, 171, 115, 100, 110, 117, 111, 98, 129};
        _dream_tourValue = [self StringFromGrandparentData:value];
    }
    return _dream_tourValue;
}

//: 请在添加的某一项后面设置间距
- (NSString *)show_sableKey {
    if (!_show_sableKey) {
        Byte value[] = {42, 5, 25, 213, 53, 157, 183, 232, 180, 151, 233, 174, 189, 231, 190, 174, 232, 162, 157, 233, 142, 144, 229, 185, 161, 233, 128, 184, 228, 144, 159, 230, 132, 154, 231, 160, 138, 229, 187, 183, 230, 168, 156, 229, 183, 175, 232, 127};
        _show_sableKey = [self StringFromGrandparentData:value];
    }
    return _show_sableKey;
}

//: layoutSubviews
- (NSString *)userAnnounceOptValue {
    if (!_userAnnounceOptValue) {
        Byte value[] = {14, 5, 232, 220, 177, 115, 119, 101, 105, 118, 98, 117, 83, 116, 117, 111, 121, 97, 108, 176};
        _userAnnounceOptValue = [self StringFromGrandparentData:value];
    }
    return _userAnnounceOptValue;
}

//: windowLevel == %ld AND hidden == 0 
- (NSString *)showBarreRepairMsg {
    if (!_showBarreRepairMsg) {
        Byte value[] = {35, 6, 108, 190, 80, 222, 32, 48, 32, 61, 61, 32, 110, 101, 100, 100, 105, 104, 32, 68, 78, 65, 32, 100, 108, 37, 32, 61, 61, 32, 108, 101, 118, 101, 76, 119, 111, 100, 110, 105, 119, 182};
        _showBarreRepairMsg = [self StringFromGrandparentData:value];
    }
    return _showBarreRepairMsg;
}

//: bounds.size
- (NSString *)mainConsensusUrl {
    if (!_mainConsensusUrl) {
        Byte value[] = {11, 4, 29, 10, 101, 122, 105, 115, 46, 115, 100, 110, 117, 111, 98, 5};
        _mainConsensusUrl = [self StringFromGrandparentData:value];
    }
    return _mainConsensusUrl;
}

//: path
- (NSString *)main_emergencyId {
    if (!_main_emergencyId) {
        Byte value[] = {4, 12, 129, 238, 144, 221, 147, 214, 160, 109, 239, 224, 104, 116, 97, 112, 82};
        _main_emergencyId = [self StringFromGrandparentData:value];
    }
    return _main_emergencyId;
}
...
@property (nonatomic, assign) AreaRadii modelCornerRadii;
//: @property (nonatomic, assign) CornerRadii modelActionSheetHeaderCornerRadii;
@property (nonatomic, assign) AreaRadii modelActionSheetHeaderCornerRadii;
//: @property (nonatomic, assign) CornerRadii modelActionSheetCancelActionCornerRadii;
@property (nonatomic, assign) AreaRadii modelActionSheetCancelActionCornerRadii;
...
@property (nonatomic, strong) WorkflowClose* modelPresentation;

//: @end
@end

//: @implementation LEEBaseConfigModel
@implementation ImageBar
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _modelCornerRadii = tableOfTexts(13.0f, 13.0f, 13.0f, 13.0f); //默认圆角半径
        //: _modelActionSheetHeaderCornerRadii = CornerRadiiMake(13.0f, 13.0f, 13.0f, 13.0f); 
        _modelActionSheetHeaderCornerRadii = tableOfTexts(13.0f, 13.0f, 13.0f, 13.0f); //默认圆角半径
        //: _modelActionSheetCancelActionCornerRadii = CornerRadiiMake(13.0f, 13.0f, 13.0f, 13.0f); 
        _modelActionSheetCancelActionCornerRadii = tableOfTexts(13.0f, 13.0f, 13.0f, 13.0f); //默认圆角半径
        ...
        _modelPresentation = [WorkflowClose windowGlass:UIWindowLevelAlert];
    }
    //: return self;
    return self;
}
...
- (LEEConfigToView)LeeCustomView{
    ...
    return ^(UIView *view){
        ...
        return self.LeeAddCustomView(^(ViewUsageTing *custom) {
...
- (LEEConfigToStringAndBlock)LeeAction{
    ...
    return ^(NSString *title, void(^block)(void)){
        ...
        return self.LeeAddAction(^(ModelButtonAction *action) {
...
- (LEEConfigToConfigLabel)LeeAddTitle{
    ...
    return ^(void(^block)(UILabel *)){
        ...
        return self.LeeAddItem(^(ShowSizeItem *item) {
...
- (LEEConfigToCustomView)LeeAddCustomView{
    ...
    return ^(void(^block)(ViewUsageTing *custom)){
...
- (LEEConfigToItem)LeeAddItem{
    ...
    return ^(void(^block)(ShowSizeItem *)){
...
- (LEEConfigToAction)LeeAddAction{
    ...
    return ^(void(^block)(ModelButtonAction *)){
...
- (LEEConfigToEdgeInsets)LeeItemInsets{
    ...
    return ^(UIEdgeInsets insets){
        ...
        //: } else {
            ...
            NSAssert(YES, [GrandparentData sharedInstance].show_sableKey);
        }
...
- (LEEConfigToFloat)LeeCornerRadius{
    ...
    return ^(CGFloat number){
        ...
        self.modelCornerRadii = tableOfTexts(number, number, number, number);
...
- (LEEConfigToPresentation)LeePresentation{
    ...
    return ^(WorkflowClose *presentation){
...
@implementation ImageBar (NoticeOld)
...
@implementation ImageBar (ReplacementTo)
...
@property (nonatomic, strong) TingImageView *leeWindow;

//: @property (nonatomic, strong) NSMutableArray <LEEBaseConfig *>*queueArray;
@property (nonatomic, strong) NSMutableArray <InfoCheckConfig *>*queueArray;

//: @property (nonatomic, strong) LEEBaseViewController *viewController;
@property (nonatomic, strong) PinViewController *viewController;

//: @end
@end

//: @protocol LEEAlertProtocol <NSObject>
@protocol EtiquetteMakeProtocol <NSObject>

//: - (void)closeWithCompletionBlock:(void (^)(void))completionBlock;
- (void)briquetWith:(void (^)(void))completionBlock;

//: @end
@end

//: @implementation LEEAlert
@implementation SetupObject

//: + (LEEAlert *)shareManager{
+ (SetupObject *)nameManager{

    //: static LEEAlert *alertManager;
    static SetupObject *alertManager;
    //: static dispatch_once_t onceToken;
    static dispatch_once_t onceToken;
    ...
    _dispatch_once(&onceToken, ^{
        ...
        alertManager = [[SetupObject alloc] init];
    //: });
    });
...
+ (ViewPathBaseConfig *)range{

    //: return [[LEEAlertConfig alloc] init];
    return [[ViewPathBaseConfig alloc] init];
}

//: + (LEEActionSheetConfig *)actionsheet{
+ (UserMaxBaseConfig *)bubble{

    //: return [[LEEActionSheetConfig alloc] init];
    return [[UserMaxBaseConfig alloc] init];
}
...
+ (TingImageView *)to{
    ...
    return [SetupObject nameManager].leeWindow;
}
...
+ (void)show:(UIWindow *)window{
    ...
    if (window) [SetupObject nameManager].mainWindow = window;
}
...
+ (void)at{
    ...
    if ([SetupObject nameManager].queueArray.count) [SetupObject nameManager].queueArray.lastObject.config.modelFinishConfig();
}
...
+ (void)providerIn{
    ...
    InfoCheckConfig * _Nullable last = [SetupObject nameManager].queueArray.lastObject;

    //: [[LEEAlert shareManager].queueArray removeAllObjects];
    [[SetupObject nameManager].queueArray removeAllObjects];

    //: if ([last respondsToSelector:@selector(close)]) [last performSelector:@selector(close)];
    if ([last respondsToSelector:@selector(customMessage)]) [last performSelector:@selector(customMessage)];
}
...
+ (BOOL)can{
    ...
    return [SetupObject nameManager].queueArray.count == 0;
}

//: + (BOOL)containsQueueWithIdentifier:(NSString *)identifier {
+ (BOOL)color:(NSString *)identifier {

    //: for (LEEBaseConfig *config in [LEEAlert shareManager].queueArray) {
    for (InfoCheckConfig *config in [SetupObject nameManager].queueArray) {
...
+ (void)black:(NSString *)identifier send:(void (^ _Nullable)(void))completionBlock{

    //: [self closeWithIdentifier:identifier force:NO completionBlock:completionBlock];
    [self value:identifier read:NO toss:completionBlock];
}

//: + (void)closeWithIdentifier:(NSString *)identifier force:(BOOL)force completionBlock:(void (^)(void))completionBlock{
+ (void)value:(NSString *)identifier read:(BOOL)force toss:(void (^)(void))completionBlock{

    //: if ([LEEAlert shareManager].queueArray.count) {
    if ([SetupObject nameManager].queueArray.count) {

        //: BOOL isLast = false;
        BOOL isLast = false;

        //: NSUInteger count = [LEEAlert shareManager].queueArray.count;
        NSUInteger count = [SetupObject nameManager].queueArray.count;
        ...
        for (NSUInteger i = 0; i < count; i++) {
            ...
            InfoCheckConfig *config = [SetupObject nameManager].queueArray[i];

            //: LEEBaseConfigModel *model = config.config;
            ImageBar *model = config.config;
            ...
            if (model.modelIdentifier != nil && [identifier isEqualToString: model.modelIdentifier]) {
                ...
                if (i == count - 1 && [[SetupObject nameManager] viewController]) {
                    //: if (force) {
                    if (force) {
        ...
        [[SetupObject nameManager].queueArray removeObjectsAtIndexes:indexs];

        //: if (isLast) {
        if (isLast) {

            //: [LEEAlert closeWithCompletionBlock:completionBlock];
            [SetupObject briquetWith:completionBlock];
...
+ (void)briquetWith:(void (^)(void))completionBlock{
    ...
    if ([SetupObject nameManager].queueArray.count) {
        ...
        InfoCheckConfig *item = [SetupObject nameManager].queueArray.lastObject;
        ...
        if ([item respondsToSelector:@selector(briquetWith:)]) [item performSelector:@selector(briquetWith:) withObject:completionBlock];
...
- (NSMutableArray <InfoCheckConfig *>*)queueArray{
    ...
    if (!_leeWindow) {
        ...
        if (@available(iOS 13.0, *)) {
            ...
            if (_mainWindow.windowScene) {
                ...
                _leeWindow = [[TingImageView alloc] initWithWindowScene: _mainWindow.windowScene];

            //: } else {
            } else {
                //: _leeWindow = [[LEEAlertWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
                _leeWindow = [[TingImageView alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
            }
...
@interface UIView (AccountTing)

//: @property (nonatomic, assign) CornerRadii lee_alert_cornerRadii;
@property (nonatomic, assign) AreaRadii lee_alert_cornerRadii;

//: @end
@end

//: @implementation UIView (LEEAlertExtension)
@implementation UIView (AccountTing)

//: CornerRadii CornerRadiiMake(CGFloat topLeft, CGFloat topRight, CGFloat bottomLeft, CGFloat bottomRight) {
AreaRadii tableOfTexts(CGFloat topLeft, CGFloat topRight, CGFloat bottomLeft, CGFloat bottomRight) {
    //: return (CornerRadii){
    return (AreaRadii){
        //: topLeft,
        topLeft,
...
CGPathRef _Nullable streetSmart(CGRect bounds, AreaRadii cornerRadii) {
...
+ (void)load{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        NSArray *selStringsArray = @[[GrandparentData sharedInstance].userAnnounceOptValue];

        //: [selStringsArray enumerateObjectsUsingBlock:^(NSString *selString, NSUInteger idx, BOOL *stop) {
        [selStringsArray enumerateObjectsUsingBlock:^(NSString *selString, NSUInteger idx, BOOL *stop) {

            //: NSString *leeSelString = [@"lee_alert_view_" stringByAppendingString:selString];
            NSString *leeSelString = [[GrandparentData sharedInstance].appFashionMessage stringByAppendingString:selString];
...
- (void)input{
    ...
    if (!imageRetUser([self lee_alert_cornerRadii], makeTable())) {
        ...
        if (!CGPathEqualToPath(lastPath, path)) {
            ...
            [lastLayer removeAnimationForKey:[GrandparentData sharedInstance].main_emergencyId];
            // 重置新路径mask
            ...
            CAAnimation *temp = [self.layer animationForKey:[GrandparentData sharedInstance].mainConsensusUrl];
            //: if (temp) {
            if (temp) {
                //: CABasicAnimation *animation = [CABasicAnimation animationWithKeyPath:@"path"];
                CABasicAnimation *animation = [CABasicAnimation animationWithKeyPath:[GrandparentData sharedInstance].main_emergencyId];
                ...
                [maskLayer addAnimation:animation forKey:[GrandparentData sharedInstance].main_emergencyId];
            }
...
- (AreaRadii)lee_alert_cornerRadii{

    //: NSValue *value = objc_getAssociatedObject(self, _cmd);
    NSValue *value = objc_getAssociatedObject(self, _cmd);

    //: CornerRadii cornerRadii;
    AreaRadii cornerRadii;
...
- (void)setLee_alert_cornerRadii:(AreaRadii)cornerRadii{

    //: NSValue *value = [NSValue valueWithBytes:&cornerRadii objCType:@encode(CornerRadii)];
    NSValue *value = [NSValue valueWithBytes:&cornerRadii objCType:@encode(AreaRadii)];
...
@interface UIButton (AccountTing)

//: @end
@end

//: @implementation UIButton (LEEAlertExtension)
@implementation UIButton (AccountTing)
...
+ (void)load{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        [selStringsArray enumerateObjectsUsingBlock:^(NSString *selString, NSUInteger idx, BOOL *stop) {
            ...
            NSString *leeSelString = [[GrandparentData sharedInstance].mainRidgeSaladNameFormat stringByAppendingString:selString];
...
@implementation TingImageView

//: @end
@end

//: @interface LEEItem ()
@interface ShowSizeItem ()

//: @property (nonatomic, copy) void (^updateBlock)(LEEItem *);
@property (nonatomic, copy) void (^updateBlock)(ShowSizeItem *);

//: @end
@end

//: @implementation LEEItem
@implementation ShowSizeItem
...
//: @interface LEEAction ()
@interface ModelButtonAction ()

//: @property (nonatomic, copy) void (^updateBlock)(LEEAction *);
@property (nonatomic, copy) void (^updateBlock)(ModelButtonAction *);

//: @end
@end

//: @implementation LEEAction
@implementation ModelButtonAction
...
@interface IncidentalView : UIView

//: @property (nonatomic, strong) LEEItem *item;
@property (nonatomic, strong) ShowSizeItem *item;

//: + (LEEItemView *)view;
+ (IncidentalView *)world;
...
+ (IncidentalView *)world{
    ...
    return [[IncidentalView alloc] init];
}
...
@implementation QuickLabel

//: + (LEEItemLabel *)label{
+ (QuickLabel *)clansman{

    //: return [[LEEItemLabel alloc] init];
    return [[QuickLabel alloc] init];
}
...
@interface FrameTitleControl : UITextField

//: @property (nonatomic, strong) LEEItem *item;
@property (nonatomic, strong) ShowSizeItem *item;

//: + (LEEItemTextField *)textField;
+ (FrameTitleControl *)tincture;

//: @end
@end

//: @implementation LEEItemTextField
@implementation FrameTitleControl

//: + (LEEItemTextField *)textField{
+ (FrameTitleControl *)tincture{

    //: return [[LEEItemTextField alloc] init];
    return [[FrameTitleControl alloc] init];
}
...
+ (ModelButton *)visualImage{
    ...
    return [ModelButton buttonWithType:UIButtonTypeCustom];;
}

//: - (void)setAction:(LEEAction *)action{
- (void)setAction:(ModelButtonAction *)action{
    ...
    if (action.backgroundColor) [self setBackgroundImage:[self high:action.backgroundColor] forState:UIControlStateNormal];
    ...
    if (action.backgroundHighlightColor) [self setBackgroundImage:[self high:action.backgroundHighlightColor] forState:UIControlStateHighlighted];
    ...
    if (action.height) [self setShow:action.height];
    ...
    //: } else {
        ...
        if (action.borderPosition & LEEActionBorderPositionTop) [self netBorder]; else [self exuviate];

        //: if (action.borderPosition & LEEActionBorderPositionBottom) [self addBottomBorder]; else [self removeBottomBorder];
        if (action.borderPosition & LEEActionBorderPositionBottom) [self visible]; else [self clearCount];

        //: if (action.borderPosition & LEEActionBorderPositionLeft) [self addLeftBorder]; else [self removeLeftBorder];
        if (action.borderPosition & LEEActionBorderPositionLeft) [self cut]; else [self doDisable];

        //: if (action.borderPosition & LEEActionBorderPositionRight) [self addRightBorder]; else [self removeRightBorder];
        if (action.borderPosition & LEEActionBorderPositionRight) [self refreshContent]; else [self inside];
    }
    ...
    action.updateBlock = ^(ModelButtonAction *act) {
...
- (CALayer *)topLayer{
    ...
    if (!_topLayer) _topLayer = [self carryWithLaminate];
...
- (CALayer *)bottomLayer{
    ...
    if (!_bottomLayer) _bottomLayer = [self carryWithLaminate];
...
- (CALayer *)leftLayer{
    ...
    if (!_leftLayer) _leftLayer = [self carryWithLaminate];
...
- (CALayer *)rightLayer{
    ...
    if (!_rightLayer) _rightLayer = [self carryWithLaminate];
...
- (void)dealloc{
    ...
    if (_container) {
        ...
        [_container removeObserver:self forKeyPath:[GrandparentData sharedInstance].dream_cabinIdent];
        //: [_container removeObserver:self forKeyPath:@"bounds"];
        [_container removeObserver:self forKeyPath:[GrandparentData sharedInstance].dream_tourValue];
    }
}
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context{
    ...
    if ([view isEqual:self.container] && self.isAutoWidth) {
        ...
        if ([keyPath isEqualToString:[GrandparentData sharedInstance].dream_cabinIdent] || [keyPath isEqualToString:[GrandparentData sharedInstance].dream_tourValue]) {
    ...
    if ([view isEqual:self.view]) {
        ...
        if ([keyPath isEqualToString:[GrandparentData sharedInstance].dream_cabinIdent]) {
        ...
        if ([keyPath isEqualToString:[GrandparentData sharedInstance].dream_tourValue]) {
...
- (UIView *)container{
    ...
    if (!_container) {
        ...
        [_container addObserver: self forKeyPath: [GrandparentData sharedInstance].dream_cabinIdent options: NSKeyValueObservingOptionNew context: nil];
        //: [_container addObserver: self forKeyPath: @"bounds" options: NSKeyValueObservingOptionNew context: nil];
        [_container addObserver: self forKeyPath: [GrandparentData sharedInstance].dream_tourValue options: NSKeyValueObservingOptionNew context: nil];
    }
...
- (void)setView:(UIView *)view{
    ...
    if (_view) {
        ...
        [_view removeObserver:self forKeyPath:[GrandparentData sharedInstance].dream_cabinIdent];
        //: [_view removeObserver:self forKeyPath:@"bounds"];
        [_view removeObserver:self forKeyPath:[GrandparentData sharedInstance].dream_tourValue];
    }
    ...
    if (_view) {
        ...
        [view addObserver: self forKeyPath: [GrandparentData sharedInstance].dream_cabinIdent options: NSKeyValueObservingOptionNew context: nil];
        //: [view addObserver: self forKeyPath: @"bounds" options: NSKeyValueObservingOptionNew context: nil];
        [view addObserver: self forKeyPath: [GrandparentData sharedInstance].dream_tourValue options: NSKeyValueObservingOptionNew context: nil];
...
@interface NamePresentation: WorkflowClose
...
@interface InheritancePresentation: WorkflowClose
...
@implementation WorkflowClose

//: + (LEEPresentationWindow *)windowLevel:(UIWindowLevel)level {
+ (NamePresentation *)windowGlass:(UIWindowLevel)level {
    //: LEEPresentationWindow *presentation = [[LEEPresentationWindow alloc] init];
    NamePresentation *presentation = [[NamePresentation alloc] init];
...
+ (InheritancePresentation *)untilControl:(UIViewController *)controller {
    //: LEEPresentationViewController *presentation = [[LEEPresentationViewController alloc] init];
    InheritancePresentation *presentation = [[InheritancePresentation alloc] init];
...
@implementation NamePresentation

//: @end
@end

//: @implementation LEEPresentationViewController
@implementation InheritancePresentation
...
@interface PinViewController ()<UIGestureRecognizerDelegate>

//: @property (nonatomic, strong) LEEBaseConfigModel *config;
@property (nonatomic, strong) ImageBar *config;
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    ...
    if (self.config.modelIsClickBackgroundClose) [self keyRecord:nil];
}
...
- (void)state:(void (^)(void))completionBlock{
...
- (void)keyRecord:(void (^)(void))completionBlock{

    //: [[LEEAlert shareManager].leeWindow endEditing:YES];
    [[SetupObject nameManager].leeWindow endEditing:YES];
}
...
- (UIWindow *)currentKeyWindow{
    ...
    if (!_currentKeyWindow) _currentKeyWindow = [SetupObject nameManager].mainWindow;
    ...
    if (_currentKeyWindow.windowLevel != UIWindowLevelNormal) {
        ...
        NSPredicate *predicate = [NSPredicate predicateWithFormat:[GrandparentData sharedInstance].showBarreRepairMsg, UIWindowLevelNormal];
    ...
    if (_currentKeyWindow) if (![SetupObject nameManager].mainWindow) [SetupObject nameManager].mainWindow = _currentKeyWindow;
...
//: #pragma mark - Alert
#pragma mark - NoticeOld

//: @interface LEEAlertViewController ()
@interface NoticeFindViewController ()
...
@property (nonatomic, strong) NSMutableArray <ModelButton *>*alertActionArray;

//: @end
@end

//: @implementation LEEAlertViewController
@implementation NoticeFindViewController
{
...
- (void)contenting:(NSNotification *)notify{
    ...
    if (self.config.modelIsAvoidKeyboard && local) {
        ...
        [UIView beginAnimations:[GrandparentData sharedInstance].main_placeMessage context:NULL];
...
- (void)viewableLayout{
    ...
    [self vanguard:CGRectGetWidth(self.view.frame) size:CGRectGetHeight(self.view.frame)];
}

//: - (void)updateAlertLayoutWithViewWidth:(CGFloat)viewWidth ViewHeight:(CGFloat)viewHeight{
- (void)vanguard:(CGFloat)viewWidth size:(CGFloat)viewHeight{
    ...
    if (isShowingKeyboard) {
        ...
        if (keyboardFrame.size.height) {
            ...
            if (self.config.modelIsActionFollowScrollEnabled) {
                ...
                CGFloat itemsHeight = [self press:alertViewMaxWidth];
            ...
            //: } else {
                ...
                CGFloat actionsHeight = [self with:0 contentWidth:alertViewMaxWidth];
            ...
            [self.itemsScrollView scrollRectToVisible:[self befored:self.itemsScrollView].frame animated:YES];
        }
...
- (CGFloat)press:(CGFloat)maxWidth{
    ...
    [self.alertItemArray enumerateObjectsUsingBlock:^(id _Nonnull item, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if ([item isKindOfClass:[UIView class]]) {
            ...
            IncidentalView *view = (IncidentalView *)item;
        ...
        } else if ([item isKindOfClass:[ViewUsageTing class]]) {

            //: LEECustomView *custom = (LEECustomView *)item;
            ViewUsageTing *custom = (ViewUsageTing *)item;
    ...
    if (self.config.modelIsActionFollowScrollEnabled) {
        ...
        finalHeight += [self with:finalHeight contentWidth:maxWidth];
    }
...
- (CGFloat)with:(CGFloat)initialPosition contentWidth:(CGFloat)maxWidth{
    ...
    for (ModelButton *button in self.alertActionArray) {
    ...
    if (self.alertActionArray.count == 2) {
        ...
        ModelButton *buttonA = self.alertActionArray.count == self.config.modelActionArray.count ? self.alertActionArray.firstObject : self.alertActionArray.lastObject;
        ...
        ModelButton *buttonB = self.alertActionArray.count == self.config.modelActionArray.count ? self.alertActionArray.lastObject : self.alertActionArray.firstObject;
...
- (void)send{
    ...
    [self.config.modelItemArray enumerateObjectsUsingBlock:^(id _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        void (^itemBlock)(ShowSizeItem *) = obj;

        //: LEEItem *item = [[LEEItem alloc] init];
        ShowSizeItem *item = [[ShowSizeItem alloc] init];
        ...
        switch (item.type) {
            ...
            case LEEItemTypeTitle:
            {
                ...
                QuickLabel *label = [QuickLabel clansman];
                ...
                label.textChangedBlock = ^{
                    ...
                    if (weakSelf) [weakSelf viewableLayout];
                //: };
                };
            }
                //: break;
            ...
            case LEEItemTypeCustomView:
            {
                ...
                void(^block)(ViewUsageTing *) = item.block;

                //: LEECustomView *custom = [[LEECustomView alloc] init];
                ViewUsageTing *custom = [[ViewUsageTing alloc] init];
            ...
            case LEEItemTypeTextField:
            {
                ...
                FrameTitleControl *textField = [FrameTitleControl tincture];
    ...
    [self.config.modelActionArray enumerateObjectsUsingBlock:^(id item, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        void (^block)(ModelButtonAction *action) = item;

        //: LEEAction *action = [[LEEAction alloc] init];
        ModelButtonAction *action = [[ModelButtonAction alloc] init];
        ...
        ModelButton *button = [ModelButton visualImage];

        //: button.action = action;
        button.action = action;

        //: [button addTarget:self action:@selector(buttonAction:) forControlEvents:UIControlEventTouchUpInside];
        [button addTarget:self action:@selector(ruddies:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)ruddies:(ModelButton *)sender{
...
- (void)dated:(UITapGestureRecognizer *)tap{

    //: if (self.config.modelIsClickHeaderClose) [self closeAnimationsWithCompletionBlock:nil];
    if (self.config.modelIsClickHeaderClose) [self keyRecord:nil];
}
...
- (void)keyRecord:(void (^)(void))completionBlock{
    ...
    [super keyRecord:completionBlock];
...
- (UIView *)befored:(UIView *)view{
    ...
    for (UIView *subView in view.subviews) {
        ...
        UIView *firstResponder = [self befored:subView];
...
- (UIScrollView *)itemsScrollView{
    ...
    if (!_itemsScrollView) {
        ...
        UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(dated:)];
...
- (NSMutableArray <ModelButton *>*)alertActionArray{
...
@property (nonatomic, strong) NSMutableArray <ModelButton *>*actionSheetActionArray;
...
@property (nonatomic, strong) ModelButton *actionSheetCancelAction;
...
- (void)provenance{
    ...
    [self childPush:CGRectGetWidth(self.view.frame) reloadInfoDimension:CGRectGetHeight(self.view.frame)];
}

//: - (void)updateActionSheetLayoutWithViewWidth:(CGFloat)viewWidth ViewHeight:(CGFloat)viewHeight{
- (void)childPush:(CGFloat)viewWidth reloadInfoDimension:(CGFloat)viewHeight{
    ...
    if (self.config.modelIsActionFollowScrollEnabled) {
        ...
        CGFloat itemsHeight = [self pull:actionSheetViewMaxWidth];
    ...
    //: } else {
        ...
        CGFloat actionsHeight = [self commentWidth:0 alongStep:actionSheetViewMaxWidth];
...
- (CGFloat)pull:(CGFloat)maxWidth{
    ...
    if (self.config.modelIsActionFollowScrollEnabled) {
        ...
        //: finalHeight += [self updateActionsLayoutWithInitialPosition:finalHeight MaxWidth:maxWidth];
        finalHeight += [self commentWidth:finalHeight alongStep:maxWidth];
    }
...
//: - (CGFloat)updateActionsLayoutWithInitialPosition:(CGFloat)initialPosition MaxWidth:(CGFloat)maxWidth{
- (CGFloat)commentWidth:(CGFloat)initialPosition alongStep:(CGFloat)maxWidth{
    ...
    for (ModelButton *button in self.actionSheetActionArray) {
        ...
        switch (item.type) {
            ...
            case LEEItemTypeTitle:
            {
                ...
                label.textChangedBlock = ^{
                    ...
                    if (weakSelf) [weakSelf provenance];
                //: };
                };
            }
                //: break;
...
- (NSMutableArray <ModelButton *>*)actionSheetActionArray{
...
@interface InfoCheckConfig ()<EtiquetteMakeProtocol>
...
@implementation InfoCheckConfig
    ...
    if (self) {
        ...
        self.config.modelFinishConfig = ^{
            ...
            if ([SetupObject nameManager].queueArray.count) {
                ...
                InfoCheckConfig *last = [SetupObject nameManager].queueArray.lastObject;
                ...
                if (!last.config.modelIsQueue && last.config.modelQueuePriority <= strongSelf.config.modelQueuePriority) {
                    ...
                    [[SetupObject nameManager].queueArray removeObject:last];
                }
                ...
                if (![[SetupObject nameManager].queueArray containsObject:strongSelf]) {

                    //: [[LEEAlert shareManager].queueArray addObject:strongSelf];
                    [[SetupObject nameManager].queueArray addObject:strongSelf];

                    //: [[LEEAlert shareManager].queueArray sortUsingComparator:^NSComparisonResult(LEEBaseConfig *configA, LEEBaseConfig *configB) {
                    [[SetupObject nameManager].queueArray sortUsingComparator:^NSComparisonResult(InfoCheckConfig *configA, InfoCheckConfig *configB) {
                ...
                if ([SetupObject nameManager].queueArray.lastObject == strongSelf) [strongSelf change];
...
- (void)change{
    ...
    if (![SetupObject nameManager].viewController) return;

    //: [LEEAlert shareManager].viewController.config = self.config;
    [SetupObject nameManager].viewController.config = self.config;

    //: if ([self.config.modelPresentation isKindOfClass:[LEEPresentationWindow class]]) {
    if ([self.config.modelPresentation isKindOfClass:[NamePresentation class]]) {

        //: LEEPresentationWindow *presentation = (LEEPresentationWindow *)self.config.modelPresentation;
        NamePresentation *presentation = (NamePresentation *)self.config.modelPresentation;

        //: [LEEAlert shareManager].leeWindow.rootViewController = [LEEAlert shareManager].viewController;
        [SetupObject nameManager].leeWindow.rootViewController = [SetupObject nameManager].viewController;

        //: [LEEAlert shareManager].leeWindow.windowLevel = presentation.windowLevel;
        [SetupObject nameManager].leeWindow.windowLevel = presentation.windowLevel;

        //: [LEEAlert shareManager].leeWindow.hidden = NO;
        [SetupObject nameManager].leeWindow.hidden = NO;

        //: if (@available(iOS 13.0, *)) {
        if (@available(iOS 13.0, *)) {
            //: [LEEAlert shareManager].leeWindow.overrideUserInterfaceStyle = self.config.modelUserInterfaceStyle;
            [SetupObject nameManager].leeWindow.overrideUserInterfaceStyle = self.config.modelUserInterfaceStyle;

        //: } else {
        } else {
            //: [[LEEAlert shareManager].leeWindow makeKeyAndVisible];
            [[SetupObject nameManager].leeWindow makeKeyAndVisible];
        }
    ...
    if ([self.config.modelPresentation isKindOfClass:[InheritancePresentation class]]) {

        //: LEEPresentationViewController *presentation = (LEEPresentationViewController *)self.config.modelPresentation;
        InheritancePresentation *presentation = (InheritancePresentation *)self.config.modelPresentation;
        ...
        [presentation.viewController addChildViewController:[SetupObject nameManager].viewController];

        //: [presentation.viewController.view addSubview:[LEEAlert shareManager].viewController.view];
        [presentation.viewController.view addSubview:[SetupObject nameManager].viewController.view];

        //: if (@available(iOS 13.0, *)) {
        if (@available(iOS 13.0, *)) {
            //: [LEEAlert shareManager].viewController.view.overrideUserInterfaceStyle = self.config.modelUserInterfaceStyle;
            [SetupObject nameManager].viewController.view.overrideUserInterfaceStyle = self.config.modelUserInterfaceStyle;
        }

        //: [LEEAlert shareManager].viewController.view.frame = presentation.viewController.view.bounds;
        [SetupObject nameManager].viewController.view.frame = presentation.viewController.view.bounds;
        ...
        [SetupObject nameManager].viewController.view.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;

        //: [[LEEAlert shareManager].viewController didMoveToParentViewController:presentation.viewController];
        [[SetupObject nameManager].viewController didMoveToParentViewController:presentation.viewController];
    ...
    [SetupObject nameManager].viewController.openFinishBlock = ^{

    //: };
    };

    //: [LEEAlert shareManager].viewController.closeFinishBlock = ^{
    [SetupObject nameManager].viewController.closeFinishBlock = ^{
        ...
        if ([SetupObject nameManager].queueArray.lastObject == strongSelf) {

            //: [strongSelf close];
            [strongSelf customMessage];

            //: [[LEEAlert shareManager].queueArray removeObject:strongSelf];
            [[SetupObject nameManager].queueArray removeObject:strongSelf];

            //: if (strongSelf.config.modelIsContinueQueueDisplay) [LEEAlert continueQueueDisplay];
            if (strongSelf.config.modelIsContinueQueueDisplay) [SetupObject at];
...
- (void)customMessage{
    ...
    if ([self.config.modelPresentation isKindOfClass:[NamePresentation class]]) {
        ...
        [SetupObject nameManager].leeWindow.hidden = YES;

        //: [[LEEAlert shareManager].leeWindow resignKeyWindow];
        [[SetupObject nameManager].leeWindow resignKeyWindow];

        //: [LEEAlert shareManager].leeWindow.rootViewController = nil;
        [SetupObject nameManager].leeWindow.rootViewController = nil;
    }
    ...
    if ([self.config.modelPresentation isKindOfClass:[InheritancePresentation class]]) {
        ...
        [[SetupObject nameManager].viewController willMoveToParentViewController:nil];

        //: [[LEEAlert shareManager].viewController.view removeFromSuperview];
        [[SetupObject nameManager].viewController.view removeFromSuperview];

        //: [[LEEAlert shareManager].viewController removeFromParentViewController];
        [[SetupObject nameManager].viewController removeFromParentViewController];
    }

    //: [LEEAlert shareManager].viewController = nil;
    [SetupObject nameManager].viewController = nil;
}
...
- (void)briquetWith:(void (^)(void))completionBlock{
    ...
    if ([SetupObject nameManager].viewController) [[SetupObject nameManager].viewController keyRecord:completionBlock];
}
...
- (ImageBar *)config{
    ...
    if (!_config) _config = [[ImageBar alloc] init];
...
@implementation ViewPathBaseConfig
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        .LeeConfigMaxHeight(^CGFloat(LEEScreenOrientationType type, CGSize size) {
            ...
            return size.height - 40.0f - ({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [SetupObject to].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).top - ({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [SetupObject to].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom;
        //: })
        })
...
- (void)change {
    ...
    [SetupObject nameManager].viewController = [[NoticeFindViewController alloc] init];
...
@implementation UserMaxBaseConfig
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        .LeeConfigMaxWidth(^CGFloat(LEEScreenOrientationType type, CGSize size) {
            ...
            return type == LEEScreenOrientationTypeHorizontal ? size.height - ({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [SetupObject to].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).top - ({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [SetupObject to].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom - 20.0f : size.width - ({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [SetupObject to].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).left - ({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [SetupObject to].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).right - 20.0f;
        //: })
        })
        //: .LeeConfigMaxHeight(^CGFloat(LEEScreenOrientationType type, CGSize size) {
        .LeeConfigMaxHeight(^CGFloat(LEEScreenOrientationType type, CGSize size) {
...
- (void)change {
    ...
    [SetupObject nameManager].viewController = [[EdgeViewController alloc] init];
