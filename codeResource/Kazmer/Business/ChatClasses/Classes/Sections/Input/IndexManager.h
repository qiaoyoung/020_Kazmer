...
@interface BubbleNameReload : NSObject
...
@interface MakeGrowingLayout : NSObject
...
@interface TitleDisplayCatalog : NSObject
//: @property (nonatomic,strong) NIMInputEmoticonLayout *layout;
@property (nonatomic,strong) MakeGrowingLayout *layout;
