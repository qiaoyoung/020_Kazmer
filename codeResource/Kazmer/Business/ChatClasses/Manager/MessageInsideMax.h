...
+ (NSDictionary *)range:(NSData *)data info:(FFFXMLReaderOptions)options itemMessage:(NSError **)errorPointer;
//: + (NSDictionary *)dictionaryForXMLString:(NSString *)string options:(FFFXMLReaderOptions)options error:(NSError **)errorPointer;
+ (NSDictionary *)filler:(NSString *)string mutual:(FFFXMLReaderOptions)options background_autoreleasing:(NSError **)errorPointer;
