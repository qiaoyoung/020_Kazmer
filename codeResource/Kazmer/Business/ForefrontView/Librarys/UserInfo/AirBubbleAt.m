...
#import "AirBubbleAt.h"

//: @implementation UserManager
@implementation AirBubbleAt

//判断是否登录
//+ (NSString *)getMobileNumber{
//    NSString *UserNo = emptyString([TableContext standardUserDefaults].mobile);
//    return UserNo;
//}
//
//+ (NSString *)getHeaderImageUrl{
//    NSString *headImageUrl = emptyString([TableContext standardUserDefaults].head_img);
//    return headImageUrl;
//}
//+ (NSString *)getNickName{
//    NSString *headImageUrl = emptyString([TableContext standardUserDefaults].user_nickname);
//    return headImageUrl;
//}
//
//+ (void)callSevicePhoneNumber{
//    NSMutableString * string = [[ NSMutableString alloc] initWithFormat: @"tel:%@", [TableContext standardUserDefaults].serverPhoneNumber];
//    [[ UIApplication sharedApplication] openURL:[ NSURL URLWithString:string]];
//}
//+ (NSString *)setPrefixURLWithURL:(NSString *)imageurl{
//    NSString *prefixStr = [TableContext standardUserDefaults].prefixURL;
//
...
//    NSString *prefixStr = [TableContext standardUserDefaults].prefixURL;
//    NSString *suffixStr = [TableContext standardUserDefaults].thumbURL;
...
//+ (NSString *)getApikey{
//    NSString *apikey = emptyString([TableContext standardUserDefaults].apikey);
//    return apikey;
//}
//
//+ (NSString *)getApisecret{
//    NSString *apisecret = emptyString([TableContext standardUserDefaults].apisecret);
//    return apisecret;
//}
...
//        return;
//    }
//    [TableContext standardUserDefaults].compId = [dict newStringValueForKey:@"compId"];
//    [TableContext standardUserDefaults].orgId = [dict newStringValueForKey:@"orgId"];
//    [TableContext standardUserDefaults].orgName = [dict newStringValueForKey:@"orgName"];
//
//
//    [TableContext standardUserDefaults].longitude = [[dict newStringValueForKey:@"longitude"] doubleValue];
//    [TableContext standardUserDefaults].latitude  = [[dict newStringValueForKey:@"latitude"] doubleValue];
//
//    [TableContext standardUserDefaults].company_latitude = [dict newStringValueForKey:@"latitude"];
//    [TableContext standardUserDefaults].company_longitude = [dict newStringValueForKey:@"longitude"];
//
//    [TableContext standardUserDefaults].province = [dict newStringValueForKey:@"province"];
//    [TableContext standardUserDefaults].city     = [dict newStringValueForKey:@"city"];
//    [TableContext standardUserDefaults].district   = [dict newStringValueForKey:@"county"];
//    [TableContext standardUserDefaults].address   = [dict newStringValueForKey:@"address"];
//
...
//            
//            [TableContext standardUserDefaults].myName = [data newStringValueForKey:@"realName"];
//            [TableContext standardUserDefaults].myHeadImg = [data newStringValueForKey:@"headImg"];
//            [TableContext standardUserDefaults].myPosition = [data newStringValueForKey:@"position"];
//            [TableContext standardUserDefaults].myCompanyName = [data newStringValueForKey:@"compName"];
//
//        }
...
+ (void)utilizer:(id)responseObject{
...
+(BOOL)more
{
//    if ([TableContext standardUserDefaults].user_id.length>0) {
//        return YES;
//    }else{
//        return NO;
//    }
...
+ (NSString *)addShow{
    ...
    NSString *userId = [TableContext name].accid;
    //: return userId;
    return userId;
}
...
//: @end
@end
//: __SAVE__ ignore_string [885.8,410.4]