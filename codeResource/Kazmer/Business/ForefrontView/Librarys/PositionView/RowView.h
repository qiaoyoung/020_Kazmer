...
- (void)should:(RowView *)cycleScrollView exhibit:(NSInteger)index;

/** 图片滚动回调 */
//: - (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView didScrollToIndex:(NSInteger)index;
- (void)change:(RowView *)cycleScrollView sendPhaseAngle:(NSInteger)index;
...
+ (instancetype)ethnos:(CGRect)frame action:(NSArray *)imageURLStringsGroup;
...
@property (nonatomic, weak) id<EndowPraise> delegate;
