...
@implementation NSDictionary (ButtonKit)

//: - (NSString *)nimkit_jsonString: (NSString *)key
- (NSString *)popText: (NSString *)key
{
...
- (NSDictionary *)sizeUser: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSArray *)contentEdge: (NSString *)key
{
...
- (NSInteger)jsonBackgroundKey: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (long long)randomKind: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
