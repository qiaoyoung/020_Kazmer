...
// __CLOSE_PRINT__
//
//  YYAnimatedImageView+Substitute4.m
// ButtonKit
//
...
#import "YYAnimatedImageView+Substitute4.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: @implementation YYAnimatedImageView (iOS14)
@implementation YYAnimatedImageView (Substitute4)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(limits:));
