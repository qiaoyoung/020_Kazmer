...
+ (UIImage *)chartletWithMessage:(NSString *)imageName readDisable:(NSString *)chartletId{
...
+ (CGSize)bringHomeImage:(CGSize)originSize
                              //: minSize:(CGSize)imageMinSize
                              can:(CGSize)imageMinSize
                              //: maxSize:(CGSize)imageMaxSiz{
                              report:(CGSize)imageMaxSiz{
    //: CGSize size;
    CGSize size;
...
+ (UIImage *)someInwards:(NSString *)imageName {
    //: if (!imageName) {
    if (!imageName) {
        //: return nil;
        return nil;
    ...
    NSString *emojiPath = [[EmptyTing sharedManager] getEmojiPath];
...
- (UIImage *)head
{
    ...
    CGFloat pixels = [[ButtonDevice currentDevice] suggestImagePixels];
...
- (UIImage *)imageOrUpload: (CGFloat)suggestPixels
{
...
- (UIImage *)streetwise: (CGFloat)maxPixels
{
    //: CGFloat width = self.size.width;
    CGFloat width = self.size.width;
    //: CGFloat height= self.size.height;
...
- (UIImage *)mustInput:(CGSize)newSize
{
    //: CGFloat width = self.size.width;
    CGFloat width = self.size.width;
    //: CGFloat height= self.size.height;
...
- (UIImage *)bignessCan:(CGSize)targetSize
{
    // 裁剪两边
