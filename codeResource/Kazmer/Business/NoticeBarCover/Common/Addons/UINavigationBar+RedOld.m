...
#import "UINavigationBar+RedOld.h"
...
@implementation UINavigationBar (RedOld)
...
+ (void)load{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        swizzling_exchangeMethod([UINavigationBar class] ,@selector(completeRecord), @selector(sumTextRemote));
    //: });
    });
}
