...
#import "UIView+Page.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: NSString * const kViewUserInfo = @"kAlertViewUserInfo";
NSString * const main_infoLinkId = @"kAlertViewUserInfo";



//: @implementation UIView (KIAdditions)
@implementation UIView (Page)
...
- (void)setUserInfo:(id)userInfo {
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(main_infoLinkId), userInfo, OBJC_ASSOCIATION_ASSIGN);
}

//: - (id)userInfo {
- (id)userInfo {
    //: return objc_getAssociatedObject(self, (__bridge const void *)(kViewUserInfo));
    return objc_getAssociatedObject(self, (__bridge const void *)(main_infoLinkId));
}
...
- (void)tinkles:(UITapGestureRecognizer *)sender {
...
- (UIViewController *)remote {
    ...
    return (UIViewController *)[self allow:self];
}
...
- (UIView *)of:(Class)superViewClass{
    ...
    if (![superView isKindOfClass:superViewClass]) {
        ...
        superView = [superView of:superViewClass];
    }
